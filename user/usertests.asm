...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      50:	00009517          	auipc	a0,0x9
      54:	e5850513          	addi	a0,a0,-424 # 8ea8 <schedule_edf_cbs+0x7f2>
    ...
    if(fd < 0){
      ...
      70:	00009517          	auipc	a0,0x9
      74:	e4050513          	addi	a0,a0,-448 # 8eb0 <schedule_edf_cbs+0x7fa>
    ...
    if(n >= 0){
      ...
      ba:	00009517          	auipc	a0,0x9
      be:	e0e50513          	addi	a0,a0,-498 # 8ec8 <schedule_edf_cbs+0x812>
    ...
    unlink("copyin1");
      e2:	00009517          	auipc	a0,0x9
      e6:	dc650513          	addi	a0,a0,-570 # 8ea8 <schedule_edf_cbs+0x7f2>
    ...
    if(n > 0){
     ...
     11e:	00009517          	auipc	a0,0x9
     122:	dda50513          	addi	a0,a0,-550 # 8ef8 <schedule_edf_cbs+0x842>
    ...
    if(pipe(fds) < 0){
     ...
     148:	0007df63          	bgez	a5,166 <copyin+0x14e>
      printf("pipe() failed\n");
     14c:	00009517          	auipc	a0,0x9
     150:	ddc50513          	addi	a0,a0,-548 # 8f28 <schedule_edf_cbs+0x872>
    ...
    if(n > 0){
     ...
     196:	00009517          	auipc	a0,0x9
     19a:	da250513          	addi	a0,a0,-606 # 8f38 <schedule_edf_cbs+0x882>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     224:	4581                	li	a1,0
     226:	00009517          	auipc	a0,0x9
     22a:	d4250513          	addi	a0,a0,-702 # 8f68 <schedule_edf_cbs+0x8b2>
    ...
    if(fd < 0){
     ...
     246:	00009517          	auipc	a0,0x9
     24a:	d2a50513          	addi	a0,a0,-726 # 8f70 <schedule_edf_cbs+0x8ba>
    ...
    if(n > 0){
     ...
     290:	00009517          	auipc	a0,0x9
     294:	cf850513          	addi	a0,a0,-776 # 8f88 <schedule_edf_cbs+0x8d2>
    ...
    if(pipe(fds) < 0){
     ...
     2c8:	0007df63          	bgez	a5,2e6 <copyout+0xf6>
      printf("pipe() failed\n");
     2cc:	00009517          	auipc	a0,0x9
     2d0:	c5c50513          	addi	a0,a0,-932 # 8f28 <schedule_edf_cbs+0x872>
    ...
    n = write(fds[1], "x", 1);
     ...
     2ea:	4605                	li	a2,1
     2ec:	00009597          	auipc	a1,0x9
     2f0:	ccc58593          	addi	a1,a1,-820 # 8fb8 <schedule_edf_cbs+0x902>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     312:	00009517          	auipc	a0,0x9
     316:	cae50513          	addi	a0,a0,-850 # 8fc0 <schedule_edf_cbs+0x90a>
    ...
    if(n > 0){
     ...
     35c:	00009517          	auipc	a0,0x9
     360:	c7c50513          	addi	a0,a0,-900 # 8fd8 <schedule_edf_cbs+0x922>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     416:	00009517          	auipc	a0,0x9
     41a:	bf250513          	addi	a0,a0,-1038 # 9008 <schedule_edf_cbs+0x952>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c0:	863a                	mv	a2,a4
     4c2:	85be                	mv	a1,a5
     4c4:	00009517          	auipc	a0,0x9
     4c8:	b6450513          	addi	a0,a0,-1180 # 9028 <schedule_edf_cbs+0x972>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     50c:	863a                	mv	a2,a4
     50e:	85be                	mv	a1,a5
     510:	00009517          	auipc	a0,0x9
     514:	b3850513          	addi	a0,a0,-1224 # 9048 <schedule_edf_cbs+0x992>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     55e:	863a                	mv	a2,a4
     560:	85be                	mv	a1,a5
     562:	00009517          	auipc	a0,0x9
     566:	b0650513          	addi	a0,a0,-1274 # 9068 <schedule_edf_cbs+0x9b2>
  ...
  char *args[] = { "xx", 0 };
     57c:	00009797          	auipc	a5,0x9
     580:	b1478793          	addi	a5,a5,-1260 # 9090 <schedule_edf_cbs+0x9da>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5bc:	863a                	mv	a2,a4
     5be:	85be                	mv	a1,a5
     5c0:	00009517          	auipc	a0,0x9
     5c4:	ad850513          	addi	a0,a0,-1320 # 9098 <schedule_edf_cbs+0x9e2>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     5f2:	00009517          	auipc	a0,0x9
     5f6:	ac650513          	addi	a0,a0,-1338 # 90b8 <schedule_edf_cbs+0xa02>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	6ce70713          	addi	a4,a4,1742 # 10ce8 <big.1275>
    ...
    big[PGSIZE] = '\0';
     ...
     64c:	6a070713          	addi	a4,a4,1696 # 10ce8 <big.1275>
     650:	6785                	lui	a5,0x1
     652:	97ba                	add	a5,a5,a4
     654:	00078023          	sb	zero,0(a5) # 1000 <truncate3+0x1aa>
    char *args2[] = { big, big, big, 0 };
     658:	00009797          	auipc	a5,0x9
     65c:	ad078793          	addi	a5,a5,-1328 # 9128 <schedule_edf_cbs+0xa72>
     660:	6390                	ld	a2,0(a5)
     662:	6794                	ld	a3,8(a5)
    ...
    ret = exec("echo", args2);
     ...
     67c:	85be                	mv	a1,a5
     67e:	00009517          	auipc	a0,0x9
     682:	a4a50513          	addi	a0,a0,-1462 # 90c8 <schedule_edf_cbs+0xa12>
    ...
    if(ret != -1){
     ...
     6a6:	85be                	mv	a1,a5
     6a8:	00009517          	auipc	a0,0x9
     6ac:	a2850513          	addi	a0,a0,-1496 # 90d0 <schedule_edf_cbs+0xa1a>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     6ee:	00009517          	auipc	a0,0x9
     6f2:	a0a50513          	addi	a0,a0,-1526 # 90f8 <schedule_edf_cbs+0xa42>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     784:	00009517          	auipc	a0,0x9
     788:	9c450513          	addi	a0,a0,-1596 # 9148 <schedule_edf_cbs+0xa92>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7de:	00009517          	auipc	a0,0x9
     7e2:	84a50513          	addi	a0,a0,-1974 # 9028 <schedule_edf_cbs+0x972>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     826:	00009517          	auipc	a0,0x9
     82a:	82250513          	addi	a0,a0,-2014 # 9048 <schedule_edf_cbs+0x992>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	7f650513          	addi	a0,a0,2038 # 9068 <schedule_edf_cbs+0x9b2>
  ...
  char *args[] = { "xx", 0 };
     88c:	00009797          	auipc	a5,0x9
     890:	80478793          	addi	a5,a5,-2044 # 9090 <schedule_edf_cbs+0x9da>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	7cc50513          	addi	a0,a0,1996 # 9098 <schedule_edf_cbs+0x9e2>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     912:	00009517          	auipc	a0,0x9
     916:	83e50513          	addi	a0,a0,-1986 # 9150 <schedule_edf_cbs+0xa9a>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     93e:	00009517          	auipc	a0,0x9
     942:	82a50513          	addi	a0,a0,-2006 # 9168 <schedule_edf_cbs+0xab2>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	2a450513          	addi	a0,a0,676 # 8c00 <schedule_edf_cbs+0x54a>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     97c:	00009517          	auipc	a0,0x9
     980:	80c50513          	addi	a0,a0,-2036 # 9188 <schedule_edf_cbs+0xad2>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	7cc50513          	addi	a0,a0,1996 # 91a0 <schedule_edf_cbs+0xaea>
  ...
  unlink("rwsbrk");
     ...
     a00:	20450513          	addi	a0,a0,516 # 8c00 <schedule_edf_cbs+0x54a>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	55a50513          	addi	a0,a0,1370 # 8f68 <schedule_edf_cbs+0x8b2>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	75a50513          	addi	a0,a0,1882 # 9188 <schedule_edf_cbs+0xad2>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	74c50513          	addi	a0,a0,1868 # 91d0 <schedule_edf_cbs+0xb1a>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	71658593          	addi	a1,a1,1814 # 9208 <schedule_edf_cbs+0xb52>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	6e450513          	addi	a0,a0,1764 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	6b050513          	addi	a0,a0,1712 # 9210 <schedule_edf_cbs+0xb5a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	67a50513          	addi	a0,a0,1658 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	66250513          	addi	a0,a0,1634 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	65850513          	addi	a0,a0,1624 # 9230 <schedule_edf_cbs+0xb7a>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	64e50513          	addi	a0,a0,1614 # 9240 <schedule_edf_cbs+0xb8a>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	62850513          	addi	a0,a0,1576 # 9260 <schedule_edf_cbs+0xbaa>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	5ee50513          	addi	a0,a0,1518 # 9240 <schedule_edf_cbs+0xb8a>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	5fe58593          	addi	a1,a1,1534 # 9270 <schedule_edf_cbs+0xbba>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	5be50513          	addi	a0,a0,1470 # 9278 <schedule_edf_cbs+0xbc2>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	58e50513          	addi	a0,a0,1422 # 9298 <schedule_edf_cbs+0xbe2>
  ...
  unlink("truncfile");
     ...
     d28:	4d450513          	addi	a0,a0,1236 # 91f8 <schedule_edf_cbs+0xb42>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	48450513          	addi	a0,a0,1156 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	47050513          	addi	a0,a0,1136 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	46458593          	addi	a1,a1,1124 # 9208 <schedule_edf_cbs+0xb52>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	43e50513          	addi	a0,a0,1086 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	1e258593          	addi	a1,a1,482 # 8fb8 <schedule_edf_cbs+0x902>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	4b250513          	addi	a0,a0,1202 # 92b8 <schedule_edf_cbs+0xc02>
  ...
  unlink("truncfile");
     ...
     e24:	3d850513          	addi	a0,a0,984 # 91f8 <schedule_edf_cbs+0xb42>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	39250513          	addi	a0,a0,914 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	44250513          	addi	a0,a0,1090 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	32e50513          	addi	a0,a0,814 # 91f8 <schedule_edf_cbs+0xb42>
     ...
     ef2:	40a50513          	addi	a0,a0,1034 # 92f8 <schedule_edf_cbs+0xc42>
     ...
     f12:	40258593          	addi	a1,a1,1026 # 9310 <schedule_edf_cbs+0xc5a>
     f16:	853e                	mv	a0,a5
     ...
     f42:	3e250513          	addi	a0,a0,994 # 9320 <schedule_edf_cbs+0xc6a>
     ...
     f6c:	29050513          	addi	a0,a0,656 # 91f8 <schedule_edf_cbs+0xb42>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	22650513          	addi	a0,a0,550 # 91f8 <schedule_edf_cbs+0xb42>
    ...
    if(fd < 0){
     ...
     ffa:	30250513          	addi	a0,a0,770 # 92f8 <schedule_edf_cbs+0xc42>
    ...
    101a:	32a58593          	addi	a1,a1,810 # 9340 <schedule_edf_cbs+0xc8a>
    101e:	853e                	mv	a0,a5
    ...
    104a:	30250513          	addi	a0,a0,770 # 9348 <schedule_edf_cbs+0xc92>
  ...
  unlink("truncfile");
    ...
    109a:	16250513          	addi	a0,a0,354 # 91f8 <schedule_edf_cbs+0xb42>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	2a850513          	addi	a0,a0,680 # 9368 <schedule_edf_cbs+0xcb2>
    ...
    10de:	29650513          	addi	a0,a0,662 # 9370 <schedule_edf_cbs+0xcba>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	27450513          	addi	a0,a0,628 # 9368 <schedule_edf_cbs+0xcb2>
    ...
    1112:	27a50513          	addi	a0,a0,634 # 9388 <schedule_edf_cbs+0xcd2>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	28050513          	addi	a0,a0,640 # 93a8 <schedule_edf_cbs+0xcf2>
    ...
    1146:	27650513          	addi	a0,a0,630 # 93b8 <schedule_edf_cbs+0xd02>
  ...
  if(chdir("/") < 0){
    ...
    1160:	27c50513          	addi	a0,a0,636 # 93d8 <schedule_edf_cbs+0xd22>
    ...
    117a:	26a50513          	addi	a0,a0,618 # 93e0 <schedule_edf_cbs+0xd2a>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	11e50513          	addi	a0,a0,286 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid == 0){
    ...
    11e8:	18450513          	addi	a0,a0,388 # 9368 <schedule_edf_cbs+0xcb2>
    ...
    1202:	17250513          	addi	a0,a0,370 # 9370 <schedule_edf_cbs+0xcba>
    ...
    121c:	15050513          	addi	a0,a0,336 # 9368 <schedule_edf_cbs+0xcb2>
    ...
    1236:	1c650513          	addi	a0,a0,454 # 93f8 <schedule_edf_cbs+0xd42>
    ...
    1250:	15c50513          	addi	a0,a0,348 # 93a8 <schedule_edf_cbs+0xcf2>
    ...
    126a:	15250513          	addi	a0,a0,338 # 93b8 <schedule_edf_cbs+0xd02>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	15e50513          	addi	a0,a0,350 # 9410 <schedule_edf_cbs+0xd5a>
    ...
    12d0:	14c50513          	addi	a0,a0,332 # 9418 <schedule_edf_cbs+0xd62>
  ...
  if(pid < 0){
    ...
    1306:	fde50513          	addi	a0,a0,-34 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid == 0){
    ...
    132a:	0ea50513          	addi	a0,a0,234 # 9410 <schedule_edf_cbs+0xd5a>
    ...
    134e:	0e650513          	addi	a0,a0,230 # 9430 <schedule_edf_cbs+0xd7a>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	09850513          	addi	a0,a0,152 # 9410 <schedule_edf_cbs+0xd5a>
    ...
    1394:	0c850513          	addi	a0,a0,200 # 9458 <schedule_edf_cbs+0xda2>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    13d2:	4581                	li	a1,0
    13d4:	00008517          	auipc	a0,0x8
    13d8:	cf450513          	addi	a0,a0,-780 # 90c8 <schedule_edf_cbs+0xa12>
  ...
  if(fd < 0){
    ...
    13fc:	07850513          	addi	a0,a0,120 # 9470 <schedule_edf_cbs+0xdba>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	06650513          	addi	a0,a0,102 # 9488 <schedule_edf_cbs+0xdd2>
  ...
  if(fd >= 0){
    ...
    144a:	05250513          	addi	a0,a0,82 # 9498 <schedule_edf_cbs+0xde2>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	04650513          	addi	a0,a0,70 # 94c0 <schedule_edf_cbs+0xe0a>
  ...
  if(fd < 0){
    ...
    14a2:	02a50513          	addi	a0,a0,42 # 94c8 <schedule_edf_cbs+0xe12>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	02458593          	addi	a1,a1,36 # 94e8 <schedule_edf_cbs+0xe32>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	00e50513          	addi	a0,a0,14 # 94f8 <schedule_edf_cbs+0xe42>
    ...
    150e:	01658593          	addi	a1,a1,22 # 9520 <schedule_edf_cbs+0xe6a>
    1512:	853e                	mv	a0,a5
  ...
  fd = open("small", O_RDONLY);
    1572:	4581                	li	a1,0
    1574:	00008517          	auipc	a0,0x8
    1578:	f4c50513          	addi	a0,a0,-180 # 94c0 <schedule_edf_cbs+0xe0a>
  ...
  if(fd < 0){
    ...
    159c:	fc050513          	addi	a0,a0,-64 # 9558 <schedule_edf_cbs+0xea2>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	01e58593          	addi	a1,a1,30 # b5d8 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15e6:	00008517          	auipc	a0,0x8
    15ea:	f9250513          	addi	a0,a0,-110 # 9578 <schedule_edf_cbs+0xec2>
  ...
  if(unlink("small") < 0){
    160e:	00008517          	auipc	a0,0x8
    1612:	eb250513          	addi	a0,a0,-334 # 94c0 <schedule_edf_cbs+0xe0a>
    ...
    1628:	00008517          	auipc	a0,0x8
    162c:	f6850513          	addi	a0,a0,-152 # 9590 <schedule_edf_cbs+0xeda>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    165c:	00008517          	auipc	a0,0x8
    1660:	f5450513          	addi	a0,a0,-172 # 95b0 <schedule_edf_cbs+0xefa>
  ...
  if(fd < 0){
    ...
    1680:	00008517          	auipc	a0,0x8
    1684:	f3850513          	addi	a0,a0,-200 # 95b8 <schedule_edf_cbs+0xf02>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	f3878793          	addi	a5,a5,-200 # b5d8 <buf>
    ...
    16ba:	f2258593          	addi	a1,a1,-222 # b5d8 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16de:	00008517          	auipc	a0,0x8
    16e2:	efa50513          	addi	a0,a0,-262 # 95d8 <schedule_edf_cbs+0xf22>
  ...
  fd = open("big", O_RDONLY);
    1720:	4581                	li	a1,0
    1722:	00008517          	auipc	a0,0x8
    1726:	e8e50513          	addi	a0,a0,-370 # 95b0 <schedule_edf_cbs+0xefa>
  ...
  if(fd < 0){
    ...
    1746:	00008517          	auipc	a0,0x8
    174a:	eba50513          	addi	a0,a0,-326 # 9600 <schedule_edf_cbs+0xf4a>
  ...
  for(;;){
    ...
    176c:	0000a597          	auipc	a1,0xa
    1770:	e6c58593          	addi	a1,a1,-404 # b5d8 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17a6:	00008517          	auipc	a0,0x8
    17aa:	e7a50513          	addi	a0,a0,-390 # 9620 <schedule_edf_cbs+0xf6a>
    ...
    17da:	00008517          	auipc	a0,0x8
    17de:	e6e50513          	addi	a0,a0,-402 # 9648 <schedule_edf_cbs+0xf92>
    ...
    if(((int*)buf)[0] != n){
    17f4:	0000a797          	auipc	a5,0xa
    17f8:	de478793          	addi	a5,a5,-540 # b5d8 <buf>
    ...
    1804:	02e78a63          	beq	a5,a4,1838 <writebig+0x1ec>
      printf("%s: read content of block %d is %d\n", s,
             n, ((int*)buf)[0]);
    1808:	0000a797          	auipc	a5,0xa
    180c:	dd078793          	addi	a5,a5,-560 # b5d8 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    181e:	00008517          	auipc	a0,0x8
    1822:	e4250513          	addi	a0,a0,-446 # 9660 <schedule_edf_cbs+0xfaa>
  ...
  if(unlink("big") < 0){
    1854:	00008517          	auipc	a0,0x8
    1858:	d5c50513          	addi	a0,a0,-676 # 95b0 <schedule_edf_cbs+0xefa>
    ...
    186e:	00008517          	auipc	a0,0x8
    1872:	e1a50513          	addi	a0,a0,-486 # 9688 <schedule_edf_cbs+0xfd2>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    196a:	00008517          	auipc	a0,0x8
    196e:	d3650513          	addi	a0,a0,-714 # 96a0 <schedule_edf_cbs+0xfea>
    ...
    1984:	00008517          	auipc	a0,0x8
    1988:	9ec50513          	addi	a0,a0,-1556 # 9370 <schedule_edf_cbs+0xcba>
  ...
  if(chdir("dir0") < 0){
    199e:	00008517          	auipc	a0,0x8
    19a2:	d0250513          	addi	a0,a0,-766 # 96a0 <schedule_edf_cbs+0xfea>
    ...
    19b8:	00008517          	auipc	a0,0x8
    19bc:	cf050513          	addi	a0,a0,-784 # 96a8 <schedule_edf_cbs+0xff2>
  ...
  if(chdir("..") < 0){
    19d2:	00008517          	auipc	a0,0x8
    19d6:	cee50513          	addi	a0,a0,-786 # 96c0 <schedule_edf_cbs+0x100a>
    ...
    19ec:	00008517          	auipc	a0,0x8
    19f0:	cdc50513          	addi	a0,a0,-804 # 96c8 <schedule_edf_cbs+0x1012>
  ...
  if(unlink("dir0") < 0){
    1a06:	00008517          	auipc	a0,0x8
    1a0a:	c9a50513          	addi	a0,a0,-870 # 96a0 <schedule_edf_cbs+0xfea>
    ...
    1a20:	00008517          	auipc	a0,0x8
    1a24:	cc050513          	addi	a0,a0,-832 # 96e0 <schedule_edf_cbs+0x102a>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	67878793          	addi	a5,a5,1656 # 90c8 <schedule_edf_cbs+0xa12>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00008797          	auipc	a5,0x8
    1a60:	c9c78793          	addi	a5,a5,-868 # 96f8 <schedule_edf_cbs+0x1042>
    1a64:	fcf43823          	sd	a5,-48(s0)
    1a68:	fc043c23          	sd	zero,-40(s0)
  char buf[3];

  unlink("echo-ok");
    1a6c:	00008517          	auipc	a0,0x8
    1a70:	c9450513          	addi	a0,a0,-876 # 9700 <schedule_edf_cbs+0x104a>
  ...
  if(pid < 0) {
    ...
    1a98:	00008517          	auipc	a0,0x8
    1a9c:	84850513          	addi	a0,a0,-1976 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid == 0) {
    ...
    1ac8:	00008517          	auipc	a0,0x8
    1acc:	c3850513          	addi	a0,a0,-968 # 9700 <schedule_edf_cbs+0x104a>
    ...
    1aec:	00008517          	auipc	a0,0x8
    1af0:	c1c50513          	addi	a0,a0,-996 # 9708 <schedule_edf_cbs+0x1052>
    ...
    1b18:	00008517          	auipc	a0,0x8
    1b1c:	c0850513          	addi	a0,a0,-1016 # 9720 <schedule_edf_cbs+0x106a>
    ...
    1b3c:	59050513          	addi	a0,a0,1424 # 90c8 <schedule_edf_cbs+0xa12>
    ...
    1b52:	00008517          	auipc	a0,0x8
    1b56:	bde50513          	addi	a0,a0,-1058 # 9730 <schedule_edf_cbs+0x107a>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b8c:	00008517          	auipc	a0,0x8
    1b90:	bbc50513          	addi	a0,a0,-1092 # 9748 <schedule_edf_cbs+0x1092>
  ...
  fd = open("echo-ok", O_RDONLY);
    1bb0:	4581                	li	a1,0
    1bb2:	00008517          	auipc	a0,0x8
    1bb6:	b4e50513          	addi	a0,a0,-1202 # 9700 <schedule_edf_cbs+0x104a>
  ...
  if(fd < 0) {
    ...
    1bda:	72250513          	addi	a0,a0,1826 # 92f8 <schedule_edf_cbs+0xc42>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c14:	00008517          	auipc	a0,0x8
    1c18:	96450513          	addi	a0,a0,-1692 # 9578 <schedule_edf_cbs+0xec2>
  ...
  unlink("echo-ok");
    1c2e:	00008517          	auipc	a0,0x8
    1c32:	ad250513          	addi	a0,a0,-1326 # 9700 <schedule_edf_cbs+0x104a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c68:	00008517          	auipc	a0,0x8
    1c6c:	af850513          	addi	a0,a0,-1288 # 9760 <schedule_edf_cbs+0x10aa>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca4:	00008517          	auipc	a0,0x8
    1ca8:	ad450513          	addi	a0,a0,-1324 # 9778 <schedule_edf_cbs+0x10c2>
  ...
  if(pid == 0){
    ...
    1d02:	0000a697          	auipc	a3,0xa
    1d06:	8d668693          	addi	a3,a3,-1834 # b5d8 <buf>
    ...
    1d36:	0000a597          	auipc	a1,0xa
    1d3a:	8a258593          	addi	a1,a1,-1886 # b5d8 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d58:	00008517          	auipc	a0,0x8
    1d5c:	a3850513          	addi	a0,a0,-1480 # 9790 <schedule_edf_cbs+0x10da>
    ...
    1dbe:	0000a717          	auipc	a4,0xa
    1dc2:	81a70713          	addi	a4,a4,-2022 # b5d8 <buf>
    ...
    1df0:	00008517          	auipc	a0,0x8
    1df4:	9b850513          	addi	a0,a0,-1608 # 97a8 <schedule_edf_cbs+0x10f2>
    ...
    1e56:	78658593          	addi	a1,a1,1926 # b5d8 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e8a:	85be                	mv	a1,a5
    1e8c:	00008517          	auipc	a0,0x8
    1e90:	93450513          	addi	a0,a0,-1740 # 97c0 <schedule_edf_cbs+0x110a>
    ...
    1ed4:	00008517          	auipc	a0,0x8
    1ed8:	90c50513          	addi	a0,a0,-1780 # 97e0 <schedule_edf_cbs+0x112a>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f1e:	00008517          	auipc	a0,0x8
    1f22:	8da50513          	addi	a0,a0,-1830 # 97f8 <schedule_edf_cbs+0x1142>
  ...
  if(pid2 < 0) {
    ...
    1f62:	38250513          	addi	a0,a0,898 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	33450513          	addi	a0,a0,820 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid3 == 0){
    ...
    1fe6:	fd658593          	addi	a1,a1,-42 # 8fb8 <schedule_edf_cbs+0x902>
    1fea:	853e                	mv	a0,a5
    ...
    2002:	00008517          	auipc	a0,0x8
    2006:	80650513          	addi	a0,a0,-2042 # 9808 <schedule_edf_cbs+0x1152>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	5a258593          	addi	a1,a1,1442 # b5d8 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	7ca50513          	addi	a0,a0,1994 # 9820 <schedule_edf_cbs+0x116a>
  ...
  printf("kill... ");
    ...
    207a:	7c250513          	addi	a0,a0,1986 # 9838 <schedule_edf_cbs+0x1182>
  ...
  printf("wait... ");
    ...
    20b4:	79850513          	addi	a0,a0,1944 # 9848 <schedule_edf_cbs+0x1192>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	1cc50513          	addi	a0,a0,460 # 92e0 <schedule_edf_cbs+0xc2a>
    ...
    215a:	70250513          	addi	a0,a0,1794 # 9858 <schedule_edf_cbs+0x11a2>
    ...
    2186:	6ee50513          	addi	a0,a0,1774 # 9870 <schedule_edf_cbs+0x11ba>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	0d450513          	addi	a0,a0,212 # 92e0 <schedule_edf_cbs+0xc2a>
    ...
    224e:	60e50513          	addi	a0,a0,1550 # 9858 <schedule_edf_cbs+0x11a2>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	ff050513          	addi	a0,a0,-16 # 92e0 <schedule_edf_cbs+0xc2a>
    ...
    2338:	00007517          	auipc	a0,0x7
    233c:	fa850513          	addi	a0,a0,-88 # 92e0 <schedule_edf_cbs+0xc2a>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	42c50513          	addi	a0,a0,1068 # 97f8 <schedule_edf_cbs+0x1142>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	40450513          	addi	a0,a0,1028 # 9890 <schedule_edf_cbs+0x11da>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	3da50513          	addi	a0,a0,986 # 98b0 <schedule_edf_cbs+0x11fa>
  ...
  if(pid < 0){
    ...
    2506:	2f650513          	addi	a0,a0,758 # 97f8 <schedule_edf_cbs+0x1142>
  ...
  if(pid == 0){
    ...
    252a:	38a50513          	addi	a0,a0,906 # 98b0 <schedule_edf_cbs+0x11fa>
    ...
    2566:	34e50513          	addi	a0,a0,846 # 98b0 <schedule_edf_cbs+0x11fa>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	32250513          	addi	a0,a0,802 # 98b0 <schedule_edf_cbs+0x11fa>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25ee:	0007df63          	bgez	a5,260c <reparent2+0x44>
      printf("fork failed\n");
    25f2:	00007517          	auipc	a0,0x7
    25f6:	ac650513          	addi	a0,a0,-1338 # 90b8 <schedule_edf_cbs+0xa02>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	1d450513          	addi	a0,a0,468 # 98c0 <schedule_edf_cbs+0x120a>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	14e50513          	addi	a0,a0,334 # 98e0 <schedule_edf_cbs+0x122a>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	10050513          	addi	a0,a0,256 # 9908 <schedule_edf_cbs+0x1252>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	4a050513          	addi	a0,a0,1184 # 8d20 <schedule_edf_cbs+0x66a>
  ...
  if(fd < 0){
    ...
    28a8:	08450513          	addi	a0,a0,132 # 9928 <schedule_edf_cbs+0x1272>
  ...
  unlink("sharedfd");
    ...
    2964:	3c050513          	addi	a0,a0,960 # 8d20 <schedule_edf_cbs+0x66a>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a2:	00007517          	auipc	a0,0x7
    29a6:	fae50513          	addi	a0,a0,-82 # 9950 <schedule_edf_cbs+0x129a>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	ff078793          	addi	a5,a5,-16 # 99b8 <schedule_edf_cbs+0x1302>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	68e50513          	addi	a0,a0,1678 # 90b8 <schedule_edf_cbs+0xa02>
    ...
    2a70:	00007517          	auipc	a0,0x7
    2a74:	ef850513          	addi	a0,a0,-264 # 9968 <schedule_edf_cbs+0x12b2>
    ...
    2a98:	85be                	mv	a1,a5
    2a9a:	00009517          	auipc	a0,0x9
    2a9e:	b3e50513          	addi	a0,a0,-1218 # b5d8 <buf>
    ...
    2ab8:	00009597          	auipc	a1,0x9
    2abc:	b2058593          	addi	a1,a1,-1248 # b5d8 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2ae4:	85be                	mv	a1,a5
    2ae6:	00007517          	auipc	a0,0x7
    2aea:	e9250513          	addi	a0,a0,-366 # 9978 <schedule_edf_cbs+0x12c2>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb2:	a0b9                	j	2c00 <fourfiles+0x244>
        if(buf[j] != '0'+i){
    2bb4:	00009717          	auipc	a4,0x9
    2bb8:	a2470713          	addi	a4,a4,-1500 # b5d8 <buf>
    ...
    2bdc:	00007517          	auipc	a0,0x7
    2be0:	db450513          	addi	a0,a0,-588 # 9990 <schedule_edf_cbs+0x12da>
    ...
    2c24:	00009597          	auipc	a1,0x9
    2c28:	9b458593          	addi	a1,a1,-1612 # b5d8 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c6a:	85be                	mv	a1,a5
    2c6c:	00007517          	auipc	a0,0x7
    2c70:	d3450513          	addi	a0,a0,-716 # 99a0 <schedule_edf_cbs+0x12ea>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	3d450513          	addi	a0,a0,980 # 90b8 <schedule_edf_cbs+0xa02>
    ...
    2d60:	00007517          	auipc	a0,0x7
    2d64:	9a850513          	addi	a0,a0,-1624 # 9708 <schedule_edf_cbs+0x1052>
    ...
    2dd8:	68450513          	addi	a0,a0,1668 # 9458 <schedule_edf_cbs+0xda2>
  ...
  for(i = 0; i < N; i++){
    ...
    2eec:	00007517          	auipc	a0,0x7
    2ef0:	aec50513          	addi	a0,a0,-1300 # 99d8 <schedule_edf_cbs+0x1322>
    ...
    2f32:	00007517          	auipc	a0,0x7
    2f36:	ace50513          	addi	a0,a0,-1330 # 9a00 <schedule_edf_cbs+0x134a>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3022:	00006517          	auipc	a0,0x6
    3026:	cc650513          	addi	a0,a0,-826 # 8ce8 <schedule_edf_cbs+0x632>
  ...
  if(fd < 0){
    ...
    3046:	00007517          	auipc	a0,0x7
    304a:	9e250513          	addi	a0,a0,-1566 # 9a28 <schedule_edf_cbs+0x1372>
  ...
  write(fd, "hello", SZ);
    ...
    3064:	4615                	li	a2,5
    3066:	00007597          	auipc	a1,0x7
    306a:	9e258593          	addi	a1,a1,-1566 # 9a48 <schedule_edf_cbs+0x1392>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    3086:	4589                	li	a1,2
    3088:	00006517          	auipc	a0,0x6
    308c:	c6050513          	addi	a0,a0,-928 # 8ce8 <schedule_edf_cbs+0x632>
  ...
  if(fd < 0){
    ...
    30ac:	00007517          	auipc	a0,0x7
    30b0:	9a450513          	addi	a0,a0,-1628 # 9a50 <schedule_edf_cbs+0x139a>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	c2250513          	addi	a0,a0,-990 # 8ce8 <schedule_edf_cbs+0x632>
    ...
    30de:	00007517          	auipc	a0,0x7
    30e2:	99250513          	addi	a0,a0,-1646 # 9a70 <schedule_edf_cbs+0x13ba>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    30fc:	00006517          	auipc	a0,0x6
    3100:	bec50513          	addi	a0,a0,-1044 # 8ce8 <schedule_edf_cbs+0x632>
  ...
  write(fd1, "yyy", 3);
    ...
    3116:	460d                	li	a2,3
    3118:	00007597          	auipc	a1,0x7
    311c:	97858593          	addi	a1,a1,-1672 # 9a90 <schedule_edf_cbs+0x13da>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	49a58593          	addi	a1,a1,1178 # b5d8 <buf>
    3146:	853e                	mv	a0,a5
    ...
    315e:	00007517          	auipc	a0,0x7
    3162:	93a50513          	addi	a0,a0,-1734 # 9a98 <schedule_edf_cbs+0x13e2>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	46078793          	addi	a5,a5,1120 # b5d8 <buf>
    ...
    3192:	00007517          	auipc	a0,0x7
    3196:	92650513          	addi	a0,a0,-1754 # 9ab8 <schedule_edf_cbs+0x1402>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	42658593          	addi	a1,a1,1062 # b5d8 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d2:	00007517          	auipc	a0,0x7
    31d6:	90650513          	addi	a0,a0,-1786 # 9ad8 <schedule_edf_cbs+0x1422>
  ...
  unlink("unlinkread");
    31fa:	00006517          	auipc	a0,0x6
    31fe:	aee50513          	addi	a0,a0,-1298 # 8ce8 <schedule_edf_cbs+0x632>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    3220:	00007517          	auipc	a0,0x7
    3224:	8d850513          	addi	a0,a0,-1832 # 9af8 <schedule_edf_cbs+0x1442>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00007517          	auipc	a0,0x7
    3234:	8d050513          	addi	a0,a0,-1840 # 9b00 <schedule_edf_cbs+0x144a>
    3238:	00004097          	auipc	ra,0x4
    323c:	e92080e7          	jalr	-366(ra) # 70ca <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    3240:	20200593          	li	a1,514
    3244:	00007517          	auipc	a0,0x7
    3248:	8b450513          	addi	a0,a0,-1868 # 9af8 <schedule_edf_cbs+0x1442>
  ...
  if(fd < 0){
    ...
    3268:	00007517          	auipc	a0,0x7
    326c:	8a050513          	addi	a0,a0,-1888 # 9b08 <schedule_edf_cbs+0x1452>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    328c:	7c058593          	addi	a1,a1,1984 # 9a48 <schedule_edf_cbs+0x1392>
    3290:	853e                	mv	a0,a5
    ...
    32a8:	00007517          	auipc	a0,0x7
    32ac:	87850513          	addi	a0,a0,-1928 # 9b20 <schedule_edf_cbs+0x146a>
  ...
  if(link("lf1", "lf2") < 0){
    32d0:	00007597          	auipc	a1,0x7
    32d4:	83058593          	addi	a1,a1,-2000 # 9b00 <schedule_edf_cbs+0x144a>
    32d8:	00007517          	auipc	a0,0x7
    32dc:	82050513          	addi	a0,a0,-2016 # 9af8 <schedule_edf_cbs+0x1442>
    ...
    32f2:	00007517          	auipc	a0,0x7
    32f6:	84650513          	addi	a0,a0,-1978 # 9b38 <schedule_edf_cbs+0x1482>
  ...
  unlink("lf1");
    ...
    3310:	7ec50513          	addi	a0,a0,2028 # 9af8 <schedule_edf_cbs+0x1442>
  ...
  if(open("lf1", 0) >= 0){
    ...
    3322:	7da50513          	addi	a0,a0,2010 # 9af8 <schedule_edf_cbs+0x1442>
    ...
    333c:	82050513          	addi	a0,a0,-2016 # 9b58 <schedule_edf_cbs+0x14a2>
  ...
  fd = open("lf2", 0);
    ...
    3358:	7ac50513          	addi	a0,a0,1964 # 9b00 <schedule_edf_cbs+0x144a>
  ...
  if(fd < 0){
    ...
    3378:	00007517          	auipc	a0,0x7
    337c:	81050513          	addi	a0,a0,-2032 # 9b88 <schedule_edf_cbs+0x14d2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3398:	00008597          	auipc	a1,0x8
    339c:	24058593          	addi	a1,a1,576 # b5d8 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33bc:	7e850513          	addi	a0,a0,2024 # 9ba0 <schedule_edf_cbs+0x14ea>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	72058593          	addi	a1,a1,1824 # 9b00 <schedule_edf_cbs+0x144a>
    33e8:	00006517          	auipc	a0,0x6
    33ec:	71850513          	addi	a0,a0,1816 # 9b00 <schedule_edf_cbs+0x144a>
    ...
    3406:	7b650513          	addi	a0,a0,1974 # 9bb8 <schedule_edf_cbs+0x1502>
  ...
  unlink("lf2");
    ...
    3420:	6e450513          	addi	a0,a0,1764 # 9b00 <schedule_edf_cbs+0x144a>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00006597          	auipc	a1,0x6
    3430:	6cc58593          	addi	a1,a1,1740 # 9af8 <schedule_edf_cbs+0x1442>
    3434:	00006517          	auipc	a0,0x6
    3438:	6cc50513          	addi	a0,a0,1740 # 9b00 <schedule_edf_cbs+0x144a>
    ...
    3452:	79250513          	addi	a0,a0,1938 # 9be0 <schedule_edf_cbs+0x152a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	69058593          	addi	a1,a1,1680 # 9af8 <schedule_edf_cbs+0x1442>
    3470:	00006517          	auipc	a0,0x6
    3474:	79850513          	addi	a0,a0,1944 # 9c08 <schedule_edf_cbs+0x1552>
    ...
    348e:	78650513          	addi	a0,a0,1926 # 9c10 <schedule_edf_cbs+0x155a>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    3522:	71250513          	addi	a0,a0,1810 # 9c30 <schedule_edf_cbs+0x157a>
    ...
    3556:	6de50513          	addi	a0,a0,1758 # 9c30 <schedule_edf_cbs+0x157a>
    ...
    3590:	6ac50513          	addi	a0,a0,1708 # 9c38 <schedule_edf_cbs+0x1582>
  ...
  fd = open(".", 0);
    ...
    3618:	5f450513          	addi	a0,a0,1524 # 9c08 <schedule_edf_cbs+0x1552>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	5da50513          	addi	a0,a0,1498 # 9c58 <schedule_edf_cbs+0x15a2>
    ...
    36b8:	5c450513          	addi	a0,a0,1476 # 9c78 <schedule_edf_cbs+0x15c2>
  ...
  if(n != N){
    ...
    372a:	57a50513          	addi	a0,a0,1402 # 9ca0 <schedule_edf_cbs+0x15ea>
  ...
  for(i = 0; i < N; i++){
    ...
    3776:	00006517          	auipc	a0,0x6
    377a:	b6a50513          	addi	a0,a0,-1174 # 92e0 <schedule_edf_cbs+0xc2a>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	6aa50513          	addi	a0,a0,1706 # 8fb8 <schedule_edf_cbs+0x902>
  ...
  if(pid < 0){
    ...
    393a:	00006517          	auipc	a0,0x6
    393e:	9a650513          	addi	a0,a0,-1626 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	61850513          	addi	a0,a0,1560 # 8fb8 <schedule_edf_cbs+0x902>
    ...
    39d6:	5e658593          	addi	a1,a1,1510 # 8fb8 <schedule_edf_cbs+0x902>
    39da:	00006517          	auipc	a0,0x6
    39de:	2fe50513          	addi	a0,a0,766 # 9cd8 <schedule_edf_cbs+0x1622>
    ...
    39f0:	5cc50513          	addi	a0,a0,1484 # 8fb8 <schedule_edf_cbs+0x902>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	29850513          	addi	a0,a0,664 # 9ce0 <schedule_edf_cbs+0x162a>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	28450513          	addi	a0,a0,644 # 9ce0 <schedule_edf_cbs+0x162a>
  ...
  if(fd < 0){
    ...
    3a84:	26850513          	addi	a0,a0,616 # 9ce8 <schedule_edf_cbs+0x1632>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	1d450513          	addi	a0,a0,468 # 9ce0 <schedule_edf_cbs+0x162a>
    ...
    3b2e:	1de50513          	addi	a0,a0,478 # 9d08 <schedule_edf_cbs+0x1652>
  ...
  unlink("bd");
    ...
    3b62:	18250513          	addi	a0,a0,386 # 9ce0 <schedule_edf_cbs+0x162a>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	14650513          	addi	a0,a0,326 # 9d28 <schedule_edf_cbs+0x1672>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	11a50513          	addi	a0,a0,282 # 9d48 <schedule_edf_cbs+0x1692>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00006517          	auipc	a0,0x6
    3c42:	11250513          	addi	a0,a0,274 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    3c5a:	10250513          	addi	a0,a0,258 # 9d58 <schedule_edf_cbs+0x16a2>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	0fc50513          	addi	a0,a0,252 # 9d70 <schedule_edf_cbs+0x16ba>
  ...
  if(fd < 0){
    ...
    3c9c:	0e050513          	addi	a0,a0,224 # 9d78 <schedule_edf_cbs+0x16c2>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	09058593          	addi	a1,a1,144 # 9d48 <schedule_edf_cbs+0x1692>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	07850513          	addi	a0,a0,120 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    3cf6:	0a650513          	addi	a0,a0,166 # 9d98 <schedule_edf_cbs+0x16e2>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	0bc50513          	addi	a0,a0,188 # 9dc8 <schedule_edf_cbs+0x1712>
    ...
    3d28:	0ac50513          	addi	a0,a0,172 # 9dd0 <schedule_edf_cbs+0x171a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	0ae50513          	addi	a0,a0,174 # 9df0 <schedule_edf_cbs+0x173a>
  ...
  if(fd < 0){
    ...
    3d6a:	09a50513          	addi	a0,a0,154 # 9e00 <schedule_edf_cbs+0x174a>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	09a58593          	addi	a1,a1,154 # 9e20 <schedule_edf_cbs+0x176a>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	08050513          	addi	a0,a0,128 # 9e28 <schedule_edf_cbs+0x1772>
  ...
  if(fd < 0){
    ...
    3dd0:	06c50513          	addi	a0,a0,108 # 9e38 <schedule_edf_cbs+0x1782>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	7ec58593          	addi	a1,a1,2028 # b5d8 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	7c678793          	addi	a5,a5,1990 # b5d8 <buf>
    ...
    3e30:	02c50513          	addi	a0,a0,44 # 9e58 <schedule_edf_cbs+0x17a2>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	02458593          	addi	a1,a1,36 # 9e78 <schedule_edf_cbs+0x17c2>
    3e5c:	00006517          	auipc	a0,0x6
    3e60:	f9450513          	addi	a0,a0,-108 # 9df0 <schedule_edf_cbs+0x173a>
    ...
    3e78:	01450513          	addi	a0,a0,20 # 9e88 <schedule_edf_cbs+0x17d2>
  ...
  if(unlink("dd/dd/ff") != 0){
    3e8e:	00006517          	auipc	a0,0x6
    3e92:	f6250513          	addi	a0,a0,-158 # 9df0 <schedule_edf_cbs+0x173a>
    ...
    3eaa:	00a50513          	addi	a0,a0,10 # 9eb0 <schedule_edf_cbs+0x17fa>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    3ec0:	4581                	li	a1,0
    3ec2:	00006517          	auipc	a0,0x6
    3ec6:	f2e50513          	addi	a0,a0,-210 # 9df0 <schedule_edf_cbs+0x173a>
    ...
    3ee0:	ff450513          	addi	a0,a0,-12 # 9ed0 <schedule_edf_cbs+0x181a>
  ...
  if(chdir("dd") != 0){
    3ef6:	00006517          	auipc	a0,0x6
    3efa:	e5a50513          	addi	a0,a0,-422 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    3f12:	fea50513          	addi	a0,a0,-22 # 9ef8 <schedule_edf_cbs+0x1842>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	fe850513          	addi	a0,a0,-24 # 9f10 <schedule_edf_cbs+0x185a>
    ...
    3f44:	fe050513          	addi	a0,a0,-32 # 9f20 <schedule_edf_cbs+0x186a>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	fe650513          	addi	a0,a0,-26 # 9f40 <schedule_edf_cbs+0x188a>
    ...
    3f76:	fde50513          	addi	a0,a0,-34 # 9f50 <schedule_edf_cbs+0x189a>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	fe450513          	addi	a0,a0,-28 # 9f70 <schedule_edf_cbs+0x18ba>
    ...
    3fa8:	fd450513          	addi	a0,a0,-44 # 9f78 <schedule_edf_cbs+0x18c2>
  ...
  fd = open("dd/dd/ffff", 0);
    3fbe:	4581                	li	a1,0
    3fc0:	00006517          	auipc	a0,0x6
    3fc4:	eb850513          	addi	a0,a0,-328 # 9e78 <schedule_edf_cbs+0x17c2>
  ...
  if(fd < 0){
    ...
    3fe4:	00006517          	auipc	a0,0x6
    3fe8:	fac50513          	addi	a0,a0,-84 # 9f90 <schedule_edf_cbs+0x18da>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	5d458593          	addi	a1,a1,1492 # b5d8 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4024:	00006517          	auipc	a0,0x6
    4028:	f8c50513          	addi	a0,a0,-116 # 9fb0 <schedule_edf_cbs+0x18fa>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    404c:	4581                	li	a1,0
    404e:	00006517          	auipc	a0,0x6
    4052:	da250513          	addi	a0,a0,-606 # 9df0 <schedule_edf_cbs+0x173a>
    ...
    4068:	00006517          	auipc	a0,0x6
    406c:	f6850513          	addi	a0,a0,-152 # 9fd0 <schedule_edf_cbs+0x191a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    4086:	00006517          	auipc	a0,0x6
    408a:	f7a50513          	addi	a0,a0,-134 # a000 <schedule_edf_cbs+0x194a>
    ...
    40a0:	00006517          	auipc	a0,0x6
    40a4:	f7050513          	addi	a0,a0,-144 # a010 <schedule_edf_cbs+0x195a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40be:	00006517          	auipc	a0,0x6
    40c2:	f7250513          	addi	a0,a0,-142 # a030 <schedule_edf_cbs+0x197a>
    ...
    40d8:	00006517          	auipc	a0,0x6
    40dc:	f6850513          	addi	a0,a0,-152 # a040 <schedule_edf_cbs+0x198a>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40f6:	00006517          	auipc	a0,0x6
    40fa:	c5a50513          	addi	a0,a0,-934 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    4110:	00006517          	auipc	a0,0x6
    4114:	f5050513          	addi	a0,a0,-176 # a060 <schedule_edf_cbs+0x19aa>
  ...
  if(open("dd", O_RDWR) >= 0){
    412a:	4589                	li	a1,2
    412c:	00006517          	auipc	a0,0x6
    4130:	c2450513          	addi	a0,a0,-988 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    4146:	00006517          	auipc	a0,0x6
    414a:	f3a50513          	addi	a0,a0,-198 # a080 <schedule_edf_cbs+0x19ca>
  ...
  if(open("dd", O_WRONLY) >= 0){
    4160:	4585                	li	a1,1
    4162:	00006517          	auipc	a0,0x6
    4166:	bee50513          	addi	a0,a0,-1042 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    417c:	00006517          	auipc	a0,0x6
    4180:	f2450513          	addi	a0,a0,-220 # a0a0 <schedule_edf_cbs+0x19ea>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    4196:	00006597          	auipc	a1,0x6
    419a:	f2a58593          	addi	a1,a1,-214 # a0c0 <schedule_edf_cbs+0x1a0a>
    419e:	00006517          	auipc	a0,0x6
    41a2:	e6250513          	addi	a0,a0,-414 # a000 <schedule_edf_cbs+0x194a>
    ...
    41b6:	00006517          	auipc	a0,0x6
    41ba:	f1a50513          	addi	a0,a0,-230 # a0d0 <schedule_edf_cbs+0x1a1a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    41d0:	00006597          	auipc	a1,0x6
    41d4:	ef058593          	addi	a1,a1,-272 # a0c0 <schedule_edf_cbs+0x1a0a>
    41d8:	00006517          	auipc	a0,0x6
    41dc:	e5850513          	addi	a0,a0,-424 # a030 <schedule_edf_cbs+0x197a>
    ...
    41f0:	00006517          	auipc	a0,0x6
    41f4:	f0850513          	addi	a0,a0,-248 # a0f8 <schedule_edf_cbs+0x1a42>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    420a:	00006597          	auipc	a1,0x6
    420e:	c6e58593          	addi	a1,a1,-914 # 9e78 <schedule_edf_cbs+0x17c2>
    4212:	00006517          	auipc	a0,0x6
    4216:	b5e50513          	addi	a0,a0,-1186 # 9d70 <schedule_edf_cbs+0x16ba>
    ...
    422a:	00006517          	auipc	a0,0x6
    422e:	ef650513          	addi	a0,a0,-266 # a120 <schedule_edf_cbs+0x1a6a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    4244:	00006517          	auipc	a0,0x6
    4248:	dbc50513          	addi	a0,a0,-580 # a000 <schedule_edf_cbs+0x194a>
    ...
    425c:	00006517          	auipc	a0,0x6
    4260:	eec50513          	addi	a0,a0,-276 # a148 <schedule_edf_cbs+0x1a92>
  ...
  if(mkdir("dd/xx/ff") == 0){
    4276:	00006517          	auipc	a0,0x6
    427a:	dba50513          	addi	a0,a0,-582 # a030 <schedule_edf_cbs+0x197a>
    ...
    428e:	00006517          	auipc	a0,0x6
    4292:	eda50513          	addi	a0,a0,-294 # a168 <schedule_edf_cbs+0x1ab2>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    42a8:	00006517          	auipc	a0,0x6
    42ac:	bd050513          	addi	a0,a0,-1072 # 9e78 <schedule_edf_cbs+0x17c2>
    ...
    42c0:	00006517          	auipc	a0,0x6
    42c4:	ec850513          	addi	a0,a0,-312 # a188 <schedule_edf_cbs+0x1ad2>
  ...
  if(unlink("dd/xx/ff") == 0){
    42da:	00006517          	auipc	a0,0x6
    42de:	d5650513          	addi	a0,a0,-682 # a030 <schedule_edf_cbs+0x197a>
    ...
    42f2:	00006517          	auipc	a0,0x6
    42f6:	ebe50513          	addi	a0,a0,-322 # a1b0 <schedule_edf_cbs+0x1afa>
  ...
  if(unlink("dd/ff/ff") == 0){
    430c:	00006517          	auipc	a0,0x6
    4310:	cf450513          	addi	a0,a0,-780 # a000 <schedule_edf_cbs+0x194a>
    ...
    4324:	00006517          	auipc	a0,0x6
    4328:	eac50513          	addi	a0,a0,-340 # a1d0 <schedule_edf_cbs+0x1b1a>
  ...
  if(chdir("dd/ff") == 0){
    433e:	00006517          	auipc	a0,0x6
    4342:	a3250513          	addi	a0,a0,-1486 # 9d70 <schedule_edf_cbs+0x16ba>
    ...
    4356:	00006517          	auipc	a0,0x6
    435a:	e9a50513          	addi	a0,a0,-358 # a1f0 <schedule_edf_cbs+0x1b3a>
  ...
  if(chdir("dd/xx") == 0){
    4370:	00006517          	auipc	a0,0x6
    4374:	ea050513          	addi	a0,a0,-352 # a210 <schedule_edf_cbs+0x1b5a>
    ...
    4388:	00006517          	auipc	a0,0x6
    438c:	e9050513          	addi	a0,a0,-368 # a218 <schedule_edf_cbs+0x1b62>
  ...
  if(unlink("dd/dd/ffff") != 0){
    43a2:	00006517          	auipc	a0,0x6
    43a6:	ad650513          	addi	a0,a0,-1322 # 9e78 <schedule_edf_cbs+0x17c2>
    ...
    43ba:	00006517          	auipc	a0,0x6
    43be:	af650513          	addi	a0,a0,-1290 # 9eb0 <schedule_edf_cbs+0x17fa>
  ...
  if(unlink("dd/ff") != 0){
    43d4:	00006517          	auipc	a0,0x6
    43d8:	99c50513          	addi	a0,a0,-1636 # 9d70 <schedule_edf_cbs+0x16ba>
    ...
    43ec:	00006517          	auipc	a0,0x6
    43f0:	e4c50513          	addi	a0,a0,-436 # a238 <schedule_edf_cbs+0x1b82>
  ...
  if(unlink("dd") == 0){
    4406:	00006517          	auipc	a0,0x6
    440a:	94a50513          	addi	a0,a0,-1718 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    441e:	00006517          	auipc	a0,0x6
    4422:	e3a50513          	addi	a0,a0,-454 # a258 <schedule_edf_cbs+0x1ba2>
  ...
  if(unlink("dd/dd") < 0){
    4438:	00006517          	auipc	a0,0x6
    443c:	e4850513          	addi	a0,a0,-440 # a280 <schedule_edf_cbs+0x1bca>
    ...
    4452:	00006517          	auipc	a0,0x6
    4456:	e3650513          	addi	a0,a0,-458 # a288 <schedule_edf_cbs+0x1bd2>
  ...
  if(unlink("dd") < 0){
    446c:	00006517          	auipc	a0,0x6
    4470:	8e450513          	addi	a0,a0,-1820 # 9d50 <schedule_edf_cbs+0x169a>
    ...
    4486:	00006517          	auipc	a0,0x6
    448a:	e2250513          	addi	a0,a0,-478 # a2a8 <schedule_edf_cbs+0x1bf2>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    44b6:	00005517          	auipc	a0,0x5
    44ba:	8a250513          	addi	a0,a0,-1886 # 8d58 <schedule_edf_cbs+0x6a2>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d4:	00005517          	auipc	a0,0x5
    44d8:	88450513          	addi	a0,a0,-1916 # 8d58 <schedule_edf_cbs+0x6a2>
    ...
    44f8:	00006517          	auipc	a0,0x6
    44fc:	dc850513          	addi	a0,a0,-568 # a2c0 <schedule_edf_cbs+0x1c0a>
    ...
    4520:	863a                	mv	a2,a4
    4522:	00007597          	auipc	a1,0x7
    4526:	0b658593          	addi	a1,a1,182 # b5d8 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455a:	00006517          	auipc	a0,0x6
    455e:	d8650513          	addi	a0,a0,-634 # a2e0 <schedule_edf_cbs+0x1c2a>
    ...
    459e:	7be50513          	addi	a0,a0,1982 # 8d58 <schedule_edf_cbs+0x6a2>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    4602:	0007df63          	bgez	a5,4620 <manywrites+0x50>
      printf("fork failed\n");
    4606:	00005517          	auipc	a0,0x5
    460a:	ab250513          	addi	a0,a0,-1358 # 90b8 <schedule_edf_cbs+0xa02>
    ...
    4690:	00006517          	auipc	a0,0x6
    4694:	c6850513          	addi	a0,a0,-920 # a2f8 <schedule_edf_cbs+0x1c42>
    ...
    46b8:	863a                	mv	a2,a4
    46ba:	00007597          	auipc	a1,0x7
    46be:	f1e58593          	addi	a1,a1,-226 # b5d8 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f2:	00006517          	auipc	a0,0x6
    46f6:	bee50513          	addi	a0,a0,-1042 # a2e0 <schedule_edf_cbs+0x1c2a>
...
bigfile(char *s)
{
  ...
  unlink("bigfile.dat");
    47ea:	00006517          	auipc	a0,0x6
    47ee:	b2650513          	addi	a0,a0,-1242 # a310 <schedule_edf_cbs+0x1c5a>
    47f2:	00003097          	auipc	ra,0x3
    47f6:	8d8080e7          	jalr	-1832(ra) # 70ca <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    47fa:	20200593          	li	a1,514
    47fe:	00006517          	auipc	a0,0x6
    4802:	b1250513          	addi	a0,a0,-1262 # a310 <schedule_edf_cbs+0x1c5a>
  ...
  if(fd < 0){
    ...
    4822:	00006517          	auipc	a0,0x6
    4826:	afe50513          	addi	a0,a0,-1282 # a320 <schedule_edf_cbs+0x1c6a>
  ...
  for(i = 0; i < N; i++){
    ...
    4886:	00006517          	auipc	a0,0x6
    488a:	aba50513          	addi	a0,a0,-1350 # a340 <schedule_edf_cbs+0x1c8a>
  ...
  fd = open("bigfile.dat", 0);
    48c6:	4581                	li	a1,0
    48c8:	00006517          	auipc	a0,0x6
    48cc:	a4850513          	addi	a0,a0,-1464 # a310 <schedule_edf_cbs+0x1c5a>
  ...
  if(fd < 0){
    ...
    48ec:	00006517          	auipc	a0,0x6
    48f0:	a7450513          	addi	a0,a0,-1420 # a360 <schedule_edf_cbs+0x1caa>
  ...
  for(i = 0; ; i++){
    ...
    4916:	00007597          	auipc	a1,0x7
    491a:	cc258593          	addi	a1,a1,-830 # b5d8 <buf>
    491e:	853e                	mv	a0,a5
    ...
    493c:	00006517          	auipc	a0,0x6
    4940:	a4450513          	addi	a0,a0,-1468 # a380 <schedule_edf_cbs+0x1cca>
    ...
    4972:	00006517          	auipc	a0,0x6
    4976:	a2e50513          	addi	a0,a0,-1490 # a3a0 <schedule_edf_cbs+0x1cea>
    ...
    498c:	00007797          	auipc	a5,0x7
    4990:	c4c78793          	addi	a5,a5,-948 # b5d8 <buf>
    ...
    49b2:	00007797          	auipc	a5,0x7
    49b6:	c2678793          	addi	a5,a5,-986 # b5d8 <buf>
    ...
    49dc:	00006517          	auipc	a0,0x6
    49e0:	9dc50513          	addi	a0,a0,-1572 # a3b8 <schedule_edf_cbs+0x1d02>
  ...
  if(total != N*SZ){
    ...
    4a36:	00006517          	auipc	a0,0x6
    4a3a:	9a250513          	addi	a0,a0,-1630 # a3d8 <schedule_edf_cbs+0x1d22>
  ...
  unlink("bigfile.dat");
    4a50:	00006517          	auipc	a0,0x6
    4a54:	8c050513          	addi	a0,a0,-1856 # a310 <schedule_edf_cbs+0x1c5a>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    4a76:	00006517          	auipc	a0,0x6
    4a7a:	98250513          	addi	a0,a0,-1662 # a3f8 <schedule_edf_cbs+0x1d42>
    ...
    4a8e:	00006517          	auipc	a0,0x6
    4a92:	97a50513          	addi	a0,a0,-1670 # a408 <schedule_edf_cbs+0x1d52>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    4aa8:	00006517          	auipc	a0,0x6
    4aac:	98850513          	addi	a0,a0,-1656 # a430 <schedule_edf_cbs+0x1d7a>
    ...
    4ac0:	00006517          	auipc	a0,0x6
    4ac4:	99050513          	addi	a0,a0,-1648 # a450 <schedule_edf_cbs+0x1d9a>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ade:	00006517          	auipc	a0,0x6
    4ae2:	9aa50513          	addi	a0,a0,-1622 # a488 <schedule_edf_cbs+0x1dd2>
  ...
  if(fd < 0){
    ...
    4b02:	00006517          	auipc	a0,0x6
    4b06:	9b650513          	addi	a0,a0,-1610 # a4b8 <schedule_edf_cbs+0x1e02>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    4b2a:	4581                	li	a1,0
    4b2c:	00006517          	auipc	a0,0x6
    4b30:	9d450513          	addi	a0,a0,-1580 # a500 <schedule_edf_cbs+0x1e4a>
  ...
  if(fd < 0){
    ...
    4b50:	00006517          	auipc	a0,0x6
    4b54:	9e050513          	addi	a0,a0,-1568 # a530 <schedule_edf_cbs+0x1e7a>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    4b78:	00006517          	auipc	a0,0x6
    4b7c:	9f850513          	addi	a0,a0,-1544 # a570 <schedule_edf_cbs+0x1eba>
    ...
    4b90:	00006517          	auipc	a0,0x6
    4b94:	a0050513          	addi	a0,a0,-1536 # a590 <schedule_edf_cbs+0x1eda>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    4baa:	00006517          	auipc	a0,0x6
    4bae:	a1e50513          	addi	a0,a0,-1506 # a5c8 <schedule_edf_cbs+0x1f12>
    ...
    4bc2:	00006517          	auipc	a0,0x6
    4bc6:	a2650513          	addi	a0,a0,-1498 # a5e8 <schedule_edf_cbs+0x1f32>
  ...
  unlink("123456789012345/12345678901234");
    4bdc:	00006517          	auipc	a0,0x6
    4be0:	9ec50513          	addi	a0,a0,-1556 # a5c8 <schedule_edf_cbs+0x1f12>
    4be4:	00002097          	auipc	ra,0x2
    4be8:	4e6080e7          	jalr	1254(ra) # 70ca <unlink>
  unlink("12345678901234/12345678901234");
    4bec:	00006517          	auipc	a0,0x6
    4bf0:	98450513          	addi	a0,a0,-1660 # a570 <schedule_edf_cbs+0x1eba>
    4bf4:	00002097          	auipc	ra,0x2
    4bf8:	4d6080e7          	jalr	1238(ra) # 70ca <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    4bfc:	00006517          	auipc	a0,0x6
    4c00:	90450513          	addi	a0,a0,-1788 # a500 <schedule_edf_cbs+0x1e4a>
    4c04:	00002097          	auipc	ra,0x2
    4c08:	4c6080e7          	jalr	1222(ra) # 70ca <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    4c0c:	00006517          	auipc	a0,0x6
    4c10:	87c50513          	addi	a0,a0,-1924 # a488 <schedule_edf_cbs+0x1dd2>
    4c14:	00002097          	auipc	ra,0x2
    4c18:	4b6080e7          	jalr	1206(ra) # 70ca <unlink>
  unlink("12345678901234/123456789012345");
    4c1c:	00006517          	auipc	a0,0x6
    4c20:	81450513          	addi	a0,a0,-2028 # a430 <schedule_edf_cbs+0x1d7a>
    4c24:	00002097          	auipc	ra,0x2
    4c28:	4a6080e7          	jalr	1190(ra) # 70ca <unlink>
  unlink("12345678901234");
    4c2c:	00005517          	auipc	a0,0x5
    4c30:	7cc50513          	addi	a0,a0,1996 # a3f8 <schedule_edf_cbs+0x1d42>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    4c52:	00006517          	auipc	a0,0x6
    4c56:	9ce50513          	addi	a0,a0,-1586 # a620 <schedule_edf_cbs+0x1f6a>
    ...
    4c6a:	00006517          	auipc	a0,0x6
    4c6e:	9be50513          	addi	a0,a0,-1602 # a628 <schedule_edf_cbs+0x1f72>
  ...
  if(chdir("dots") != 0){
    4c84:	00006517          	auipc	a0,0x6
    4c88:	99c50513          	addi	a0,a0,-1636 # a620 <schedule_edf_cbs+0x1f6a>
    ...
    4c9c:	00006517          	auipc	a0,0x6
    4ca0:	9a450513          	addi	a0,a0,-1628 # a640 <schedule_edf_cbs+0x1f8a>
  ...
  if(unlink(".") == 0){
    4cb6:	00005517          	auipc	a0,0x5
    4cba:	f5250513          	addi	a0,a0,-174 # 9c08 <schedule_edf_cbs+0x1552>
    ...
    4cce:	00006517          	auipc	a0,0x6
    4cd2:	98a50513          	addi	a0,a0,-1654 # a658 <schedule_edf_cbs+0x1fa2>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	9d850513          	addi	a0,a0,-1576 # 96c0 <schedule_edf_cbs+0x100a>
    ...
    4d00:	00006517          	auipc	a0,0x6
    4d04:	97050513          	addi	a0,a0,-1680 # a670 <schedule_edf_cbs+0x1fba>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	6be50513          	addi	a0,a0,1726 # 93d8 <schedule_edf_cbs+0xd22>
    ...
    4d36:	6ae50513          	addi	a0,a0,1710 # 93e0 <schedule_edf_cbs+0xd2a>
  ...
  if(unlink("dots/.") == 0){
    4d4c:	00006517          	auipc	a0,0x6
    4d50:	93c50513          	addi	a0,a0,-1732 # a688 <schedule_edf_cbs+0x1fd2>
    ...
    4d64:	00006517          	auipc	a0,0x6
    4d68:	92c50513          	addi	a0,a0,-1748 # a690 <schedule_edf_cbs+0x1fda>
  ...
  if(unlink("dots/..") == 0){
    4d7e:	00006517          	auipc	a0,0x6
    4d82:	93250513          	addi	a0,a0,-1742 # a6b0 <schedule_edf_cbs+0x1ffa>
    ...
    4d96:	00006517          	auipc	a0,0x6
    4d9a:	92250513          	addi	a0,a0,-1758 # a6b8 <schedule_edf_cbs+0x2002>
  ...
  if(unlink("dots") != 0){
    4db0:	00006517          	auipc	a0,0x6
    4db4:	87050513          	addi	a0,a0,-1936 # a620 <schedule_edf_cbs+0x1f6a>
    ...
    4dc8:	00006517          	auipc	a0,0x6
    4dcc:	91050513          	addi	a0,a0,-1776 # a6d8 <schedule_edf_cbs+0x2022>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	08450513          	addi	a0,a0,132 # 8e80 <schedule_edf_cbs+0x7ca>
  ...
  if(fd < 0){
    ...
    4e20:	00006517          	auipc	a0,0x6
    4e24:	8d850513          	addi	a0,a0,-1832 # a6f8 <schedule_edf_cbs+0x2042>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	03850513          	addi	a0,a0,56 # 8e80 <schedule_edf_cbs+0x7ca>
    ...
    4e60:	00006517          	auipc	a0,0x6
    4e64:	8b850513          	addi	a0,a0,-1864 # a718 <schedule_edf_cbs+0x2062>
  ...
  fd = open("dirfile/xx", 0);
    4e7a:	4581                	li	a1,0
    4e7c:	00006517          	auipc	a0,0x6
    4e80:	8bc50513          	addi	a0,a0,-1860 # a738 <schedule_edf_cbs+0x2082>
  ...
  if(fd >= 0){
    ...
    4ea0:	00006517          	auipc	a0,0x6
    4ea4:	8a850513          	addi	a0,a0,-1880 # a748 <schedule_edf_cbs+0x2092>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ebe:	00006517          	auipc	a0,0x6
    4ec2:	87a50513          	addi	a0,a0,-1926 # a738 <schedule_edf_cbs+0x2082>
  ...
  if(fd >= 0){
    ...
    4ee2:	00006517          	auipc	a0,0x6
    4ee6:	86650513          	addi	a0,a0,-1946 # a748 <schedule_edf_cbs+0x2092>
  ...
  if(mkdir("dirfile/xx") == 0){
    4efc:	00006517          	auipc	a0,0x6
    4f00:	83c50513          	addi	a0,a0,-1988 # a738 <schedule_edf_cbs+0x2082>
    ...
    4f14:	00006517          	auipc	a0,0x6
    4f18:	85c50513          	addi	a0,a0,-1956 # a770 <schedule_edf_cbs+0x20ba>
  ...
  if(unlink("dirfile/xx") == 0){
    4f2e:	00006517          	auipc	a0,0x6
    4f32:	80a50513          	addi	a0,a0,-2038 # a738 <schedule_edf_cbs+0x2082>
    ...
    4f46:	00006517          	auipc	a0,0x6
    4f4a:	85250513          	addi	a0,a0,-1966 # a798 <schedule_edf_cbs+0x20e2>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4f64:	7d858593          	addi	a1,a1,2008 # a738 <schedule_edf_cbs+0x2082>
    ...
    4f80:	00006517          	auipc	a0,0x6
    4f84:	84050513          	addi	a0,a0,-1984 # a7c0 <schedule_edf_cbs+0x210a>
  ...
  if(unlink("dirfile") != 0){
    4f9a:	00004517          	auipc	a0,0x4
    4f9e:	ee650513          	addi	a0,a0,-282 # 8e80 <schedule_edf_cbs+0x7ca>
    ...
    4fb2:	00006517          	auipc	a0,0x6
    4fb6:	83650513          	addi	a0,a0,-1994 # a7e8 <schedule_edf_cbs+0x2132>
  ...
  fd = open(".", O_RDWR);
    4fcc:	4589                	li	a1,2
    4fce:	00005517          	auipc	a0,0x5
    4fd2:	c3a50513          	addi	a0,a0,-966 # 9c08 <schedule_edf_cbs+0x1552>
  ...
  if(fd >= 0){
    ...
    4ff2:	00006517          	auipc	a0,0x6
    4ff6:	81650513          	addi	a0,a0,-2026 # a808 <schedule_edf_cbs+0x2152>
  ...
  fd = open(".", 0);
    500c:	4581                	li	a1,0
    500e:	00005517          	auipc	a0,0x5
    5012:	bfa50513          	addi	a0,a0,-1030 # 9c08 <schedule_edf_cbs+0x1552>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    5028:	4605                	li	a2,1
    502a:	00004597          	auipc	a1,0x4
    502e:	f8e58593          	addi	a1,a1,-114 # 8fb8 <schedule_edf_cbs+0x902>
    5032:	853e                	mv	a0,a5
    ...
    504a:	7ea50513          	addi	a0,a0,2026 # a830 <schedule_edf_cbs+0x217a>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    508e:	7be50513          	addi	a0,a0,1982 # a848 <schedule_edf_cbs+0x2192>
    ...
    50a6:	7ae50513          	addi	a0,a0,1966 # a850 <schedule_edf_cbs+0x219a>
    ...
    50c0:	78c50513          	addi	a0,a0,1932 # a848 <schedule_edf_cbs+0x2192>
    ...
    50d8:	79450513          	addi	a0,a0,1940 # a868 <schedule_edf_cbs+0x21b2>
    ...
    50f2:	79250513          	addi	a0,a0,1938 # a880 <schedule_edf_cbs+0x21ca>
    50f6:	00002097          	auipc	ra,0x2
    50fa:	fec080e7          	jalr	-20(ra) # 70e2 <mkdir>
    link("README", "");
    50fe:	00005597          	auipc	a1,0x5
    5102:	78258593          	addi	a1,a1,1922 # a880 <schedule_edf_cbs+0x21ca>
    5106:	00004517          	auipc	a0,0x4
    510a:	e6250513          	addi	a0,a0,-414 # 8f68 <schedule_edf_cbs+0x8b2>
    510e:	00002097          	auipc	ra,0x2
    5112:	fcc080e7          	jalr	-52(ra) # 70da <link>
    fd = open("", O_CREATE);
    5116:	20000593          	li	a1,512
    511a:	00005517          	auipc	a0,0x5
    511e:	76650513          	addi	a0,a0,1894 # a880 <schedule_edf_cbs+0x21ca>
    ...
    514c:	00004517          	auipc	a0,0x4
    5150:	f4450513          	addi	a0,a0,-188 # 9090 <schedule_edf_cbs+0x9da>
    ...
    unlink("xx");
    517a:	00004517          	auipc	a0,0x4
    517e:	f1650513          	addi	a0,a0,-234 # 9090 <schedule_edf_cbs+0x9da>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	51650513          	addi	a0,a0,1302 # 96c0 <schedule_edf_cbs+0x100a>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00005517          	auipc	a0,0x5
    51be:	68e50513          	addi	a0,a0,1678 # a848 <schedule_edf_cbs+0x2192>
  ...
  chdir("/");
    ...
    51e8:	1f450513          	addi	a0,a0,500 # 93d8 <schedule_edf_cbs+0xd22>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	62450513          	addi	a0,a0,1572 # a888 <schedule_edf_cbs+0x21d2>
  ...
  if(n == N){
    ...
    5296:	60e50513          	addi	a0,a0,1550 # a8a0 <schedule_edf_cbs+0x21ea>
  ...
  for(; n > 0; n--){
    ...
    52c4:	60850513          	addi	a0,a0,1544 # a8c8 <schedule_edf_cbs+0x2212>
  ...
  if(wait(0) != -1){
    ...
    530a:	5da50513          	addi	a0,a0,1498 # a8e0 <schedule_edf_cbs+0x222a>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	5aa50513          	addi	a0,a0,1450 # a8f8 <schedule_edf_cbs+0x2242>
  ...
  if(xstatus == 1){
    ...
    53f4:	52850513          	addi	a0,a0,1320 # a918 <schedule_edf_cbs+0x2262>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	4f250513          	addi	a0,a0,1266 # a938 <schedule_edf_cbs+0x2282>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffee1e0>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	4ac50513          	addi	a0,a0,1196 # a958 <schedule_edf_cbs+0x22a2>
  ...
  if(c != a + 1){
    ...
    54f8:	48450513          	addi	a0,a0,1156 # a978 <schedule_edf_cbs+0x22c2>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	40050513          	addi	a0,a0,1024 # a998 <schedule_edf_cbs+0x22e2>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63ee1e0>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	3b450513          	addi	a0,a0,948 # a9e0 <schedule_edf_cbs+0x232a>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	39050513          	addi	a0,a0,912 # aa00 <schedule_edf_cbs+0x234a>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	36a50513          	addi	a0,a0,874 # aa40 <schedule_edf_cbs+0x238a>
  ...
  if(*lastaddr == 99){
    ...
    570a:	36a50513          	addi	a0,a0,874 # aa70 <schedule_edf_cbs+0x23ba>
  ...
  if(c != a){
    ...
    576c:	34050513          	addi	a0,a0,832 # aaa8 <schedule_edf_cbs+0x23f2>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	b2250513          	addi	a0,a0,-1246 # 92e0 <schedule_edf_cbs+0xc2a>
    ...
    57f8:	2dc50513          	addi	a0,a0,732 # aad0 <schedule_edf_cbs+0x241a>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0x590>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002b65f>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5882:	00004517          	auipc	a0,0x4
    5886:	ef650513          	addi	a0,a0,-266 # 9778 <schedule_edf_cbs+0x10c2>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	6be58593          	addi	a1,a1,1726 # 8fb8 <schedule_edf_cbs+0x902>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	11a50513          	addi	a0,a0,282 # aaf0 <schedule_edf_cbs+0x243a>
  ...
  if(pid < 0){
    ...
    5a0c:	00004517          	auipc	a0,0x4
    5a10:	8d450513          	addi	a0,a0,-1836 # 92e0 <schedule_edf_cbs+0xc2a>
  ...
  if(pid == 0){
    ...
    5a96:	07e50513          	addi	a0,a0,126 # ab10 <schedule_edf_cbs+0x245a>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	03c50513          	addi	a0,a0,60 # ab40 <schedule_edf_cbs+0x248a>
  ...
  unlink("sbrk");
    ...
    5b1e:	02650513          	addi	a0,a0,38 # ab40 <schedule_edf_cbs+0x248a>
  ...
  if(fd < 0)  {
    ...
    5b3c:	01050513          	addi	a0,a0,16 # ab48 <schedule_edf_cbs+0x2492>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	fe650513          	addi	a0,a0,-26 # ab60 <schedule_edf_cbs+0x24aa>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc4:	00004517          	auipc	a0,0x4
    5bc8:	bb450513          	addi	a0,a0,-1100 # 9778 <schedule_edf_cbs+0x10c2>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c06:	85be                	mv	a1,a5
    5c08:	00005517          	auipc	a0,0x5
    5c0c:	f7050513          	addi	a0,a0,-144 # ab78 <schedule_edf_cbs+0x24c2>
    ...
    5c26:	00005517          	auipc	a0,0x5
    5c2a:	f6250513          	addi	a0,a0,-158 # ab88 <schedule_edf_cbs+0x24d2>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    5c7a:	00009717          	auipc	a4,0x9
    5c7e:	95e70713          	addi	a4,a4,-1698 # e5d8 <uninit>
    ...
    5c92:	00005517          	auipc	a0,0x5
    5c96:	f1650513          	addi	a0,a0,-234 # aba8 <schedule_edf_cbs+0x24f2>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    5cde:	00005517          	auipc	a0,0x5
    5ce2:	ee250513          	addi	a0,a0,-286 # abc0 <schedule_edf_cbs+0x250a>
  ...
  if(pid == 0){
    ...
    5d0a:	0000c717          	auipc	a4,0xc
    5d0e:	fe670713          	addi	a4,a4,-26 # 11cf0 <args.1845>
    5d12:	fec42783          	lw	a5,-20(s0)
    5d16:	078e                	slli	a5,a5,0x3
    5d18:	97ba                	add	a5,a5,a4
    5d1a:	00005717          	auipc	a4,0x5
    5d1e:	eb670713          	addi	a4,a4,-330 # abd0 <schedule_edf_cbs+0x251a>
    ...
    args[MAXARG-1] = 0;
    5d3c:	0000c797          	auipc	a5,0xc
    5d40:	fb478793          	addi	a5,a5,-76 # 11cf0 <args.1845>
    5d44:	0e07bc23          	sd	zero,248(a5)
    exec("echo", args);
    5d48:	0000c597          	auipc	a1,0xc
    5d4c:	fa858593          	addi	a1,a1,-88 # 11cf0 <args.1845>
    5d50:	00003517          	auipc	a0,0x3
    5d54:	37850513          	addi	a0,a0,888 # 90c8 <schedule_edf_cbs+0xa12>
    5d58:	00001097          	auipc	ra,0x1
    5d5c:	35a080e7          	jalr	858(ra) # 70b2 <exec>
    fd = open("bigarg-ok", O_CREATE);
    5d60:	20000593          	li	a1,512
    5d64:	00005517          	auipc	a0,0x5
    5d68:	e5c50513          	addi	a0,a0,-420 # abc0 <schedule_edf_cbs+0x250a>
    ...
    5da0:	00005517          	auipc	a0,0x5
    5da4:	f1050513          	addi	a0,a0,-240 # acb0 <schedule_edf_cbs+0x25fa>
  ...
  fd = open("bigarg-ok", 0);
    5ddc:	4581                	li	a1,0
    5dde:	00005517          	auipc	a0,0x5
    5de2:	de250513          	addi	a0,a0,-542 # abc0 <schedule_edf_cbs+0x250a>
  ...
  if(fd < 0){
    ...
    5e02:	00005517          	auipc	a0,0x5
    5e06:	ece50513          	addi	a0,a0,-306 # acd0 <schedule_edf_cbs+0x261a>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    5e40:	00005517          	auipc	a0,0x5
    5e44:	eb050513          	addi	a0,a0,-336 # acf0 <schedule_edf_cbs+0x263a>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef0:	85be                	mv	a1,a5
    5ef2:	00005517          	auipc	a0,0x5
    5ef6:	e0e50513          	addi	a0,a0,-498 # ad00 <schedule_edf_cbs+0x264a>
    ...
    5f28:	85be                	mv	a1,a5
    5f2a:	00005517          	auipc	a0,0x5
    5f2e:	de650513          	addi	a0,a0,-538 # ad10 <schedule_edf_cbs+0x265a>
    ...
    5f4c:	69058593          	addi	a1,a1,1680 # b5d8 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f90:	85be                	mv	a1,a5
    5f92:	00005517          	auipc	a0,0x5
    5f96:	d8e50513          	addi	a0,a0,-626 # ad20 <schedule_edf_cbs+0x266a>
  ...
  printf("fsfull test finished\n");
    6082:	00005517          	auipc	a0,0x5
    6086:	cae50513          	addi	a0,a0,-850 # ad30 <schedule_edf_cbs+0x267a>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    60a8:	4581                	li	a1,0
    60aa:	00005517          	auipc	a0,0x5
    60ae:	c9e50513          	addi	a0,a0,-866 # ad48 <schedule_edf_cbs+0x2692>
  ...
  if (fd < 0) {
    ...
    60d2:	22a50513          	addi	a0,a0,554 # 92f8 <schedule_edf_cbs+0xc42>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	49878793          	addi	a5,a5,1176 # b5c0 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x1847ed>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6dd53f>
    6146:	973e                	add	a4,a4,a5
    6148:	00005797          	auipc	a5,0x5
    614c:	47878793          	addi	a5,a5,1144 # b5c0 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00005797          	auipc	a5,0x5
    6156:	46e78793          	addi	a5,a5,1134 # b5c0 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffed1e0>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00005517          	auipc	a0,0x5
    61b6:	b9e50513          	addi	a0,a0,-1122 # ad50 <schedule_edf_cbs+0x269a>
    ...
    61de:	10650513          	addi	a0,a0,262 # 92e0 <schedule_edf_cbs+0xc2a>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	0c678793          	addi	a5,a5,198 # b300 <schedule_edf_cbs+0x2c4a>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	0b078793          	addi	a5,a5,176 # b300 <schedule_edf_cbs+0x2c4a>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
    6292:	00003517          	auipc	a0,0x3
    6296:	e2650513          	addi	a0,a0,-474 # 90b8 <schedule_edf_cbs+0xa02>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
    6304:	00003517          	auipc	a0,0x3
    6308:	db450513          	addi	a0,a0,-588 # 90b8 <schedule_edf_cbs+0xa02>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
    637c:	00003517          	auipc	a0,0x3
    6380:	d3c50513          	addi	a0,a0,-708 # 90b8 <schedule_edf_cbs+0xa02>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    6400:	00005517          	auipc	a0,0x5
    6404:	97850513          	addi	a0,a0,-1672 # ad78 <schedule_edf_cbs+0x26c2>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641a:	00005517          	auipc	a0,0x5
    641e:	95e50513          	addi	a0,a0,-1698 # ad78 <schedule_edf_cbs+0x26c2>
    ...
    643a:	00005517          	auipc	a0,0x5
    643e:	94650513          	addi	a0,a0,-1722 # ad80 <schedule_edf_cbs+0x26ca>
    ...
    unlink("junk");
    6478:	00005517          	auipc	a0,0x5
    647c:	90050513          	addi	a0,a0,-1792 # ad78 <schedule_edf_cbs+0x26c2>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64a6:	00005517          	auipc	a0,0x5
    64aa:	8d250513          	addi	a0,a0,-1838 # ad78 <schedule_edf_cbs+0x26c2>
  ...
  if(fd < 0){
    ...
    printf("open junk failed\n");
    64c6:	00005517          	auipc	a0,0x5
    64ca:	8ba50513          	addi	a0,a0,-1862 # ad80 <schedule_edf_cbs+0x26ca>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64e4:	4605                	li	a2,1
    64e6:	00003597          	auipc	a1,0x3
    64ea:	ad258593          	addi	a1,a1,-1326 # 8fb8 <schedule_edf_cbs+0x902>
    64ee:	853e                	mv	a0,a5
    ...
    printf("write failed\n");
    6502:	00005517          	auipc	a0,0x5
    6506:	89650513          	addi	a0,a0,-1898 # ad98 <schedule_edf_cbs+0x26e2>
  ...
  unlink("junk");
    652a:	00005517          	auipc	a0,0x5
    652e:	84e50513          	addi	a0,a0,-1970 # ad78 <schedule_edf_cbs+0x26c2>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    6566:	85be                	mv	a1,a5
    6568:	00003517          	auipc	a0,0x3
    656c:	b6050513          	addi	a0,a0,-1184 # 90c8 <schedule_edf_cbs+0xa12>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0x58f>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65c4:	0007df63          	bgez	a5,65e2 <execout+0x44>
      printf("fork failed\n");
    65c8:	00003517          	auipc	a0,0x3
    65cc:	af050513          	addi	a0,a0,-1296 # 90b8 <schedule_edf_cbs+0xa02>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <schedule_edf_cbs+0x294a>
      while(1){
    ...
    664a:	a5c080e7          	jalr	-1444(ra) # 70a2 <close>
      char *args[] = { "echo", "x", 0 };
    664e:	00003797          	auipc	a5,0x3
    6652:	a7a78793          	addi	a5,a5,-1414 # 90c8 <schedule_edf_cbs+0xa12>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00003797          	auipc	a5,0x3
    665e:	95e78793          	addi	a5,a5,-1698 # 8fb8 <schedule_edf_cbs+0x902>
    6662:	fcf43423          	sd	a5,-56(s0)
    6666:	fc043823          	sd	zero,-48(s0)
      exec("echo", args);
    666a:	fc040793          	addi	a5,s0,-64
    666e:	85be                	mv	a1,a5
    6670:	00003517          	auipc	a0,0x3
    6674:	a5850513          	addi	a0,a0,-1448 # 90c8 <schedule_edf_cbs+0xa12>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	6d650513          	addi	a0,a0,1750 # ada8 <schedule_edf_cbs+0x26f2>
  ...
  if(pid < 0){
    ...
    6708:	6c450513          	addi	a0,a0,1732 # adc8 <schedule_edf_cbs+0x2712>
  ...
  if(pid == 0){
    ...
    6764:	4605                	li	a2,1
    6766:	00003597          	auipc	a1,0x3
    676a:	85258593          	addi	a1,a1,-1966 # 8fb8 <schedule_edf_cbs+0x902>
    676e:	853e                	mv	a0,a5
    ...
    6786:	66650513          	addi	a0,a0,1638 # ade8 <schedule_edf_cbs+0x2732>
  ...
  while(1){
    ...
    67e4:	62850513          	addi	a0,a0,1576 # ae08 <schedule_edf_cbs+0x2752>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	5de50513          	addi	a0,a0,1502 # ae28 <schedule_edf_cbs+0x2772>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	5c650513          	addi	a0,a0,1478 # ae38 <schedule_edf_cbs+0x2782>
  ...
  if(pid == 0) {
    ...
    68c0:	59450513          	addi	a0,a0,1428 # ae50 <schedule_edf_cbs+0x279a>
    ...
    68d2:	58a50513          	addi	a0,a0,1418 # ae58 <schedule_edf_cbs+0x27a2>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	53258593          	addi	a1,a1,1330 # ae60 <schedule_edf_cbs+0x27aa>
    6936:	853e                	mv	a0,a5
    ...
    6966:	50658593          	addi	a1,a1,1286 # ae68 <schedule_edf_cbs+0x27b2>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	4b250513          	addi	a0,a0,1202 # ae70 <schedule_edf_cbs+0x27ba>
  ...
  struct test {
    ...
    69dc:	57870713          	addi	a4,a4,1400 # af50 <schedule_edf_cbs+0x289a>
  ...
  if(continuous){
    ...
    6a04:	49850513          	addi	a0,a0,1176 # ae98 <schedule_edf_cbs+0x27e2>
    ...
    6a6e:	44e50513          	addi	a0,a0,1102 # aeb8 <schedule_edf_cbs+0x2802>
    ...
    6ac4:	41050513          	addi	a0,a0,1040 # aed0 <schedule_edf_cbs+0x281a>
  ...
  printf("usertests starting\n");
    ...
    6aec:	40850513          	addi	a0,a0,1032 # aef0 <schedule_edf_cbs+0x283a>
  ...
  if(fail){
    ...
    6b76:	34650513          	addi	a0,a0,838 # aeb8 <schedule_edf_cbs+0x2802>
    ...
    6bba:	35250513          	addi	a0,a0,850 # af08 <schedule_edf_cbs+0x2852>
    ...
    6bd4:	36850513          	addi	a0,a0,872 # af38 <schedule_edf_cbs+0x2882>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	3aa68693          	addi	a3,a3,938 # b588 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	2d070713          	addi	a4,a4,720 # b588 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    7476:	eb8d                	bnez	a5,74a8 <vprintf+0x1a6>
          s = "(null)";
    7478:	00004797          	auipc	a5,0x4
    747c:	e9078793          	addi	a5,a5,-368 # b308 <schedule_edf_cbs+0x2c52>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	7dc78793          	addi	a5,a5,2012 # 11e00 <freep>
  ...
  freep = p;
    ...
    7720:	6e478793          	addi	a5,a5,1764 # 11e00 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	66278793          	addi	a5,a5,1634 # 11e00 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	63078793          	addi	a5,a5,1584 # 11e00 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	57278793          	addi	a5,a5,1394 # 11e00 <freep>
    ...
    78a8:	55c78793          	addi	a5,a5,1372 # 11e00 <freep>
...
0000000000007966 <__list_add>:
 ...
 {
    7966:	7179                	addi	sp,sp,-48
    7968:	f422                	sd	s0,40(sp)
    796a:	1800                	addi	s0,sp,48
    796c:	fea43423          	sd	a0,-24(s0)
    7970:	feb43023          	sd	a1,-32(s0)
    7974:	fcc43c23          	sd	a2,-40(s0)
     next->prev = new_entry;
    7978:	fd843783          	ld	a5,-40(s0)
    797c:	fe843703          	ld	a4,-24(s0)
    7980:	e798                	sd	a4,8(a5)
     new_entry->next = next;
    7982:	fe843783          	ld	a5,-24(s0)
    7986:	fd843703          	ld	a4,-40(s0)
    798a:	e398                	sd	a4,0(a5)
     new_entry->prev = prev;
    798c:	fe843783          	ld	a5,-24(s0)
    7990:	fe043703          	ld	a4,-32(s0)
    7994:	e798                	sd	a4,8(a5)
     prev->next = new_entry;
    7996:	fe043783          	ld	a5,-32(s0)
    799a:	fe843703          	ld	a4,-24(s0)
    799e:	e398                	sd	a4,0(a5)
 }
    79a0:	0001                	nop
    79a2:	7422                	ld	s0,40(sp)
    79a4:	6145                	addi	sp,sp,48
    79a6:	8082                	ret

00000000000079a8 <list_add_tail>:
  *
 ...
 {
    79a8:	1101                	addi	sp,sp,-32
    79aa:	ec06                	sd	ra,24(sp)
    79ac:	e822                	sd	s0,16(sp)
    79ae:	1000                	addi	s0,sp,32
    79b0:	fea43423          	sd	a0,-24(s0)
    79b4:	feb43023          	sd	a1,-32(s0)
     __list_add(new_entry, head->prev, head);
    79b8:	fe043783          	ld	a5,-32(s0)
    79bc:	679c                	ld	a5,8(a5)
    79be:	fe043603          	ld	a2,-32(s0)
    79c2:	85be                	mv	a1,a5
    79c4:	fe843503          	ld	a0,-24(s0)
    79c8:	00000097          	auipc	ra,0x0
    79cc:	f9e080e7          	jalr	-98(ra) # 7966 <__list_add>
 }
    79d0:	0001                	nop
    79d2:	60e2                	ld	ra,24(sp)
    79d4:	6442                	ld	s0,16(sp)
    79d6:	6105                	addi	sp,sp,32
    79d8:	8082                	ret

00000000000079da <__list_del>:
  *
 ...
 {
    79da:	1101                	addi	sp,sp,-32
    79dc:	ec22                	sd	s0,24(sp)
    79de:	1000                	addi	s0,sp,32
    79e0:	fea43423          	sd	a0,-24(s0)
    79e4:	feb43023          	sd	a1,-32(s0)
     next->prev = prev;
    79e8:	fe043783          	ld	a5,-32(s0)
    79ec:	fe843703          	ld	a4,-24(s0)
    79f0:	e798                	sd	a4,8(a5)
     prev->next = next;
    79f2:	fe843783          	ld	a5,-24(s0)
    79f6:	fe043703          	ld	a4,-32(s0)
    79fa:	e398                	sd	a4,0(a5)
 }
    79fc:	0001                	nop
    79fe:	6462                	ld	s0,24(sp)
    7a00:	6105                	addi	sp,sp,32
    7a02:	8082                	ret

0000000000007a04 <list_del>:
 ...
 {
    7a04:	1101                	addi	sp,sp,-32
    7a06:	ec06                	sd	ra,24(sp)
    7a08:	e822                	sd	s0,16(sp)
    7a0a:	1000                	addi	s0,sp,32
    7a0c:	fea43423          	sd	a0,-24(s0)
     __list_del(entry->prev, entry->next);
    7a10:	fe843783          	ld	a5,-24(s0)
    7a14:	6798                	ld	a4,8(a5)
    7a16:	fe843783          	ld	a5,-24(s0)
    7a1a:	639c                	ld	a5,0(a5)
    7a1c:	85be                	mv	a1,a5
    7a1e:	853a                	mv	a0,a4
    7a20:	00000097          	auipc	ra,0x0
    7a24:	fba080e7          	jalr	-70(ra) # 79da <__list_del>
     entry->next = LIST_POISON1;
    7a28:	fe843783          	ld	a5,-24(s0)
    7a2c:	00100737          	lui	a4,0x100
    7a30:	10070713          	addi	a4,a4,256 # 100100 <__BSS_END__+0xee2e0>
    7a34:	e398                	sd	a4,0(a5)
     entry->prev = LIST_POISON2;
    7a36:	fe843783          	ld	a5,-24(s0)
    7a3a:	00200737          	lui	a4,0x200
    7a3e:	20070713          	addi	a4,a4,512 # 200200 <__BSS_END__+0x1ee3e0>
    7a42:	e798                	sd	a4,8(a5)
 }
    7a44:	0001                	nop
    7a46:	60e2                	ld	ra,24(sp)
    7a48:	6442                	ld	s0,16(sp)
    7a4a:	6105                	addi	sp,sp,32
    7a4c:	8082                	ret

0000000000007a4e <list_empty>:
 /**
 ...
 {
    7a4e:	1101                	addi	sp,sp,-32
    7a50:	ec22                	sd	s0,24(sp)
    7a52:	1000                	addi	s0,sp,32
    7a54:	fea43423          	sd	a0,-24(s0)
     return head->next == head;
    7a58:	fe843783          	ld	a5,-24(s0)
    7a5c:	639c                	ld	a5,0(a5)
    7a5e:	fe843703          	ld	a4,-24(s0)
    7a62:	40f707b3          	sub	a5,a4,a5
    7a66:	0017b793          	seqz	a5,a5
    7a6a:	0ff7f793          	andi	a5,a5,255
    7a6e:	2781                	sext.w	a5,a5
 }
    7a70:	853e                	mv	a0,a5
    7a72:	6462                	ld	s0,24(sp)
    7a74:	6105                	addi	sp,sp,32
    7a76:	8082                	ret

0000000000007a78 <thread_create>:
...
{
    7a78:	715d                	addi	sp,sp,-80
    7a7a:	e486                	sd	ra,72(sp)
    7a7c:	e0a2                	sd	s0,64(sp)
    7a7e:	0880                	addi	s0,sp,80
    7a80:	fca43423          	sd	a0,-56(s0)
    7a84:	fcb43023          	sd	a1,-64(s0)
    7a88:	85b2                	mv	a1,a2
    7a8a:	8636                	mv	a2,a3
    7a8c:	86ba                	mv	a3,a4
    7a8e:	873e                	mv	a4,a5
    7a90:	87ae                	mv	a5,a1
    7a92:	faf42e23          	sw	a5,-68(s0)
    7a96:	87b2                	mv	a5,a2
    7a98:	faf42c23          	sw	a5,-72(s0)
    7a9c:	87b6                	mv	a5,a3
    7a9e:	faf42a23          	sw	a5,-76(s0)
    7aa2:	87ba                	mv	a5,a4
    7aa4:	faf42823          	sw	a5,-80(s0)
    static int _id = 1;
    struct thread *t = (struct thread *)malloc(sizeof(struct thread));
    7aa8:	08000513          	li	a0,128
    7aac:	00000097          	auipc	ra,0x0
    7ab0:	d06080e7          	jalr	-762(ra) # 77b2 <malloc>
    7ab4:	fea43423          	sd	a0,-24(s0)
    unsigned long new_stack_p;
    unsigned long new_stack;
    new_stack = (unsigned long)malloc(sizeof(unsigned long) * 0x200);
    7ab8:	6505                	lui	a0,0x1
    7aba:	00000097          	auipc	ra,0x0
    7abe:	cf8080e7          	jalr	-776(ra) # 77b2 <malloc>
    7ac2:	87aa                	mv	a5,a0
    7ac4:	fef43023          	sd	a5,-32(s0)
    new_stack_p = new_stack + 0x200 * 8 - 0x2 * 8;
    7ac8:	fe043703          	ld	a4,-32(s0)
    7acc:	6785                	lui	a5,0x1
    7ace:	17c1                	addi	a5,a5,-16
    7ad0:	97ba                	add	a5,a5,a4
    7ad2:	fcf43c23          	sd	a5,-40(s0)
    t->fp = f;
    7ad6:	fe843783          	ld	a5,-24(s0)
    7ada:	fc843703          	ld	a4,-56(s0)
    7ade:	e398                	sd	a4,0(a5)
    t->arg = arg;
    7ae0:	fe843783          	ld	a5,-24(s0)
    7ae4:	fc043703          	ld	a4,-64(s0)
    7ae8:	e798                	sd	a4,8(a5)
    t->ID = _id++;
    7aea:	00004797          	auipc	a5,0x4
    7aee:	ae278793          	addi	a5,a5,-1310 # b5cc <_id.1241>
    7af2:	439c                	lw	a5,0(a5)
    7af4:	0017871b          	addiw	a4,a5,1
    7af8:	0007069b          	sext.w	a3,a4
    7afc:	00004717          	auipc	a4,0x4
    7b00:	ad070713          	addi	a4,a4,-1328 # b5cc <_id.1241>
    7b04:	c314                	sw	a3,0(a4)
    7b06:	fe843703          	ld	a4,-24(s0)
    7b0a:	df5c                	sw	a5,60(a4)
    t->buf_set = 0;
    7b0c:	fe843783          	ld	a5,-24(s0)
    7b10:	0207a023          	sw	zero,32(a5)
    t->stack = (void *)new_stack;
    7b14:	fe043703          	ld	a4,-32(s0)
    7b18:	fe843783          	ld	a5,-24(s0)
    7b1c:	eb98                	sd	a4,16(a5)
    t->stack_p = (void *)new_stack_p;
    7b1e:	fd843703          	ld	a4,-40(s0)
    7b22:	fe843783          	ld	a5,-24(s0)
    7b26:	ef98                	sd	a4,24(a5)

    t->processing_time = processing_time;
    7b28:	fe843783          	ld	a5,-24(s0)
    7b2c:	fb842703          	lw	a4,-72(s0)
    7b30:	c3f8                	sw	a4,68(a5)
    t->period = period;
    7b32:	fe843783          	ld	a5,-24(s0)
    7b36:	fb442703          	lw	a4,-76(s0)
    7b3a:	c7f8                	sw	a4,76(a5)
    t->deadline = period;
    7b3c:	fe843783          	ld	a5,-24(s0)
    7b40:	fb442703          	lw	a4,-76(s0)
    7b44:	c7b8                	sw	a4,72(a5)
    t->n = n;
    7b46:	fe843783          	ld	a5,-24(s0)
    7b4a:	fb042703          	lw	a4,-80(s0)
    7b4e:	cbb8                	sw	a4,80(a5)
    t->is_real_time = is_real_time;
    7b50:	fe843783          	ld	a5,-24(s0)
    7b54:	fbc42703          	lw	a4,-68(s0)
    7b58:	c3b8                	sw	a4,64(a5)
    t->remaining_time = processing_time;
    7b5a:	fe843783          	ld	a5,-24(s0)
    7b5e:	fb842703          	lw	a4,-72(s0)
    7b62:	cbf8                	sw	a4,84(a5)
    t->current_deadline = 0;
    7b64:	fe843783          	ld	a5,-24(s0)
    7b68:	0407ac23          	sw	zero,88(a5)
    t->priority = 100;
    7b6c:	fe843783          	ld	a5,-24(s0)
    7b70:	06400713          	li	a4,100
    7b74:	cff8                	sw	a4,92(a5)
    t->arrival_time = 30000;
    7b76:	fe843783          	ld	a5,-24(s0)
    7b7a:	671d                	lui	a4,0x7
    7b7c:	5307071b          	addiw	a4,a4,1328
    7b80:	d3b8                	sw	a4,96(a5)
    
    return t;
    7b82:	fe843783          	ld	a5,-24(s0)
}
    7b86:	853e                	mv	a0,a5
    7b88:	60a6                	ld	ra,72(sp)
    7b8a:	6406                	ld	s0,64(sp)
    7b8c:	6161                	addi	sp,sp,80
    7b8e:	8082                	ret

0000000000007b90 <thread_set_priority>:

void thread_set_priority(struct thread *t, int priority)
{
    7b90:	1101                	addi	sp,sp,-32
    7b92:	ec22                	sd	s0,24(sp)
    7b94:	1000                	addi	s0,sp,32
    7b96:	fea43423          	sd	a0,-24(s0)
    7b9a:	87ae                	mv	a5,a1
    7b9c:	fef42223          	sw	a5,-28(s0)
    t->priority = priority;
    7ba0:	fe843783          	ld	a5,-24(s0)
    7ba4:	fe442703          	lw	a4,-28(s0)
    7ba8:	cff8                	sw	a4,92(a5)
}
    7baa:	0001                	nop
    7bac:	6462                	ld	s0,24(sp)
    7bae:	6105                	addi	sp,sp,32
    7bb0:	8082                	ret

0000000000007bb2 <init_thread_cbs>:
void init_thread_cbs(struct thread *t, int budget, int is_hard_rt)
{
    7bb2:	1101                	addi	sp,sp,-32
    7bb4:	ec22                	sd	s0,24(sp)
    7bb6:	1000                	addi	s0,sp,32
    7bb8:	fea43423          	sd	a0,-24(s0)
    7bbc:	87ae                	mv	a5,a1
    7bbe:	8732                	mv	a4,a2
    7bc0:	fef42223          	sw	a5,-28(s0)
    7bc4:	87ba                	mv	a5,a4
    7bc6:	fef42023          	sw	a5,-32(s0)
    t->cbs.budget = budget;
    7bca:	fe843783          	ld	a5,-24(s0)
    7bce:	fe442703          	lw	a4,-28(s0)
    7bd2:	d3f8                	sw	a4,100(a5)
    t->cbs.remaining_budget = budget; 
    7bd4:	fe843783          	ld	a5,-24(s0)
    7bd8:	fe442703          	lw	a4,-28(s0)
    7bdc:	d7b8                	sw	a4,104(a5)
    t->cbs.is_hard_rt = is_hard_rt;
    7bde:	fe843783          	ld	a5,-24(s0)
    7be2:	fe042703          	lw	a4,-32(s0)
    7be6:	d7f8                	sw	a4,108(a5)
    t->cbs.is_throttled = 0;
    7be8:	fe843783          	ld	a5,-24(s0)
    7bec:	0607a823          	sw	zero,112(a5)
    t->cbs.throttled_arrived_time = 0;
    7bf0:	fe843783          	ld	a5,-24(s0)
    7bf4:	0607aa23          	sw	zero,116(a5)
    t->cbs.throttle_new_deadline = 0;
    7bf8:	fe843783          	ld	a5,-24(s0)
    7bfc:	0607ac23          	sw	zero,120(a5)
    t->cbs.remaining_time_at_throttle = 0;
    7c00:	fe843783          	ld	a5,-24(s0)
    7c04:	0607ae23          	sw	zero,124(a5)
}
    7c08:	0001                	nop
    7c0a:	6462                	ld	s0,24(sp)
    7c0c:	6105                	addi	sp,sp,32
    7c0e:	8082                	ret

0000000000007c10 <thread_add_at>:
void thread_add_at(struct thread *t, int arrival_time)
{
    7c10:	7179                	addi	sp,sp,-48
    7c12:	f406                	sd	ra,40(sp)
    7c14:	f022                	sd	s0,32(sp)
    7c16:	1800                	addi	s0,sp,48
    7c18:	fca43c23          	sd	a0,-40(s0)
    7c1c:	87ae                	mv	a5,a1
    7c1e:	fcf42a23          	sw	a5,-44(s0)
    struct release_queue_entry *new_entry = (struct release_queue_entry *)malloc(sizeof(struct release_queue_entry));
    7c22:	02000513          	li	a0,32
    7c26:	00000097          	auipc	ra,0x0
    7c2a:	b8c080e7          	jalr	-1140(ra) # 77b2 <malloc>
    7c2e:	fea43423          	sd	a0,-24(s0)
    new_entry->thrd = t;
    7c32:	fe843783          	ld	a5,-24(s0)
    7c36:	fd843703          	ld	a4,-40(s0)
    7c3a:	e398                	sd	a4,0(a5)
    new_entry->release_time = arrival_time;
    7c3c:	fe843783          	ld	a5,-24(s0)
    7c40:	fd442703          	lw	a4,-44(s0)
    7c44:	cf98                	sw	a4,24(a5)
    t->arrival_time = arrival_time;
    7c46:	fd843783          	ld	a5,-40(s0)
    7c4a:	fd442703          	lw	a4,-44(s0)
    7c4e:	d3b8                	sw	a4,96(a5)

    // t->remaining_time = t->processing_time;
    if (t->is_real_time) {
    7c50:	fd843783          	ld	a5,-40(s0)
    7c54:	43bc                	lw	a5,64(a5)
    7c56:	cf81                	beqz	a5,7c6e <thread_add_at+0x5e>
        t->current_deadline = arrival_time + t->deadline;
    7c58:	fd843783          	ld	a5,-40(s0)
    7c5c:	47bc                	lw	a5,72(a5)
    7c5e:	fd442703          	lw	a4,-44(s0)
    7c62:	9fb9                	addw	a5,a5,a4
    7c64:	0007871b          	sext.w	a4,a5
    7c68:	fd843783          	ld	a5,-40(s0)
    7c6c:	cfb8                	sw	a4,88(a5)
    }
    list_add_tail(&new_entry->thread_list, &release_queue);
    7c6e:	fe843783          	ld	a5,-24(s0)
    7c72:	07a1                	addi	a5,a5,8
    7c74:	00004597          	auipc	a1,0x4
    7c78:	93c58593          	addi	a1,a1,-1732 # b5b0 <release_queue>
    7c7c:	853e                	mv	a0,a5
    7c7e:	00000097          	auipc	ra,0x0
    7c82:	d2a080e7          	jalr	-726(ra) # 79a8 <list_add_tail>
}
    7c86:	0001                	nop
    7c88:	70a2                	ld	ra,40(sp)
    7c8a:	7402                	ld	s0,32(sp)
    7c8c:	6145                	addi	sp,sp,48
    7c8e:	8082                	ret

0000000000007c90 <__release>:

void __release()
{
    7c90:	7139                	addi	sp,sp,-64
    7c92:	fc06                	sd	ra,56(sp)
    7c94:	f822                	sd	s0,48(sp)
    7c96:	0080                	addi	s0,sp,64
    struct release_queue_entry *cur, *nxt;
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
    7c98:	00004797          	auipc	a5,0x4
    7c9c:	91878793          	addi	a5,a5,-1768 # b5b0 <release_queue>
    7ca0:	639c                	ld	a5,0(a5)
    7ca2:	fcf43c23          	sd	a5,-40(s0)
    7ca6:	fd843783          	ld	a5,-40(s0)
    7caa:	17e1                	addi	a5,a5,-8
    7cac:	fef43423          	sd	a5,-24(s0)
    7cb0:	fe843783          	ld	a5,-24(s0)
    7cb4:	679c                	ld	a5,8(a5)
    7cb6:	fcf43823          	sd	a5,-48(s0)
    7cba:	fd043783          	ld	a5,-48(s0)
    7cbe:	17e1                	addi	a5,a5,-8
    7cc0:	fef43023          	sd	a5,-32(s0)
    7cc4:	a0e9                	j	7d8e <__release+0xfe>
        if (threading_system_time >= cur->release_time) {
    7cc6:	fe843783          	ld	a5,-24(s0)
    7cca:	4f98                	lw	a4,24(a5)
    7ccc:	0000a797          	auipc	a5,0xa
    7cd0:	14478793          	addi	a5,a5,324 # 11e10 <threading_system_time>
    7cd4:	439c                	lw	a5,0(a5)
    7cd6:	08e7ce63          	blt	a5,a4,7d72 <__release+0xe2>
            if(cur->thrd->cbs.is_throttled){
    7cda:	fe843783          	ld	a5,-24(s0)
    7cde:	639c                	ld	a5,0(a5)
    7ce0:	5bbc                	lw	a5,112(a5)
    7ce2:	c79d                	beqz	a5,7d10 <__release+0x80>
                cur->thrd->cbs.is_throttled = 0;
    7ce4:	fe843783          	ld	a5,-24(s0)
    7ce8:	639c                	ld	a5,0(a5)
    7cea:	0607a823          	sw	zero,112(a5)
                cur->thrd->cbs.remaining_budget = cur->thrd->cbs.budget;
    7cee:	fe843783          	ld	a5,-24(s0)
    7cf2:	6398                	ld	a4,0(a5)
    7cf4:	fe843783          	ld	a5,-24(s0)
    7cf8:	639c                	ld	a5,0(a5)
    7cfa:	5378                	lw	a4,100(a4)
    7cfc:	d7b8                	sw	a4,104(a5)
                cur->thrd->remaining_time = cur->thrd->cbs.remaining_time_at_throttle;
    7cfe:	fe843783          	ld	a5,-24(s0)
    7d02:	6398                	ld	a4,0(a5)
    7d04:	fe843783          	ld	a5,-24(s0)
    7d08:	639c                	ld	a5,0(a5)
    7d0a:	5f78                	lw	a4,124(a4)
    7d0c:	cbf8                	sw	a4,84(a5)
    7d0e:	a809                	j	7d20 <__release+0x90>
            }else{
                cur->thrd->remaining_time = cur->thrd->processing_time;
    7d10:	fe843783          	ld	a5,-24(s0)
    7d14:	6398                	ld	a4,0(a5)
    7d16:	fe843783          	ld	a5,-24(s0)
    7d1a:	639c                	ld	a5,0(a5)
    7d1c:	4378                	lw	a4,68(a4)
    7d1e:	cbf8                	sw	a4,84(a5)
            }
            cur->thrd->current_deadline = cur->release_time + cur->thrd->deadline;
    7d20:	fe843783          	ld	a5,-24(s0)
    7d24:	4f94                	lw	a3,24(a5)
    7d26:	fe843783          	ld	a5,-24(s0)
    7d2a:	639c                	ld	a5,0(a5)
    7d2c:	47b8                	lw	a4,72(a5)
    7d2e:	fe843783          	ld	a5,-24(s0)
    7d32:	639c                	ld	a5,0(a5)
    7d34:	9f35                	addw	a4,a4,a3
    7d36:	2701                	sext.w	a4,a4
    7d38:	cfb8                	sw	a4,88(a5)
            list_add_tail(&cur->thrd->thread_list, &run_queue);
    7d3a:	fe843783          	ld	a5,-24(s0)
    7d3e:	639c                	ld	a5,0(a5)
    7d40:	02878793          	addi	a5,a5,40
    7d44:	00004597          	auipc	a1,0x4
    7d48:	85c58593          	addi	a1,a1,-1956 # b5a0 <run_queue>
    7d4c:	853e                	mv	a0,a5
    7d4e:	00000097          	auipc	ra,0x0
    7d52:	c5a080e7          	jalr	-934(ra) # 79a8 <list_add_tail>
            list_del(&cur->thread_list);
    7d56:	fe843783          	ld	a5,-24(s0)
    7d5a:	07a1                	addi	a5,a5,8
    7d5c:	853e                	mv	a0,a5
    7d5e:	00000097          	auipc	ra,0x0
    7d62:	ca6080e7          	jalr	-858(ra) # 7a04 <list_del>
            free(cur);
    7d66:	fe843503          	ld	a0,-24(s0)
    7d6a:	00000097          	auipc	ra,0x0
    7d6e:	8a6080e7          	jalr	-1882(ra) # 7610 <free>
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list) {
    7d72:	fe043783          	ld	a5,-32(s0)
    7d76:	fef43423          	sd	a5,-24(s0)
    7d7a:	fe043783          	ld	a5,-32(s0)
    7d7e:	679c                	ld	a5,8(a5)
    7d80:	fcf43423          	sd	a5,-56(s0)
    7d84:	fc843783          	ld	a5,-56(s0)
    7d88:	17e1                	addi	a5,a5,-8
    7d8a:	fef43023          	sd	a5,-32(s0)
    7d8e:	fe843783          	ld	a5,-24(s0)
    7d92:	00878713          	addi	a4,a5,8
    7d96:	00004797          	auipc	a5,0x4
    7d9a:	81a78793          	addi	a5,a5,-2022 # b5b0 <release_queue>
    7d9e:	f2f714e3          	bne	a4,a5,7cc6 <__release+0x36>
        }
    }
}
    7da2:	0001                	nop
    7da4:	0001                	nop
    7da6:	70e2                	ld	ra,56(sp)
    7da8:	7442                	ld	s0,48(sp)
    7daa:	6121                	addi	sp,sp,64
    7dac:	8082                	ret

0000000000007dae <__thread_exit>:

void __thread_exit(struct thread *to_remove)
{
    7dae:	1101                	addi	sp,sp,-32
    7db0:	ec06                	sd	ra,24(sp)
    7db2:	e822                	sd	s0,16(sp)
    7db4:	1000                	addi	s0,sp,32
    7db6:	fea43423          	sd	a0,-24(s0)
    current = to_remove->thread_list.prev;
    7dba:	fe843783          	ld	a5,-24(s0)
    7dbe:	7b98                	ld	a4,48(a5)
    7dc0:	0000a797          	auipc	a5,0xa
    7dc4:	04878793          	addi	a5,a5,72 # 11e08 <current>
    7dc8:	e398                	sd	a4,0(a5)
    list_del(&to_remove->thread_list);
    7dca:	fe843783          	ld	a5,-24(s0)
    7dce:	02878793          	addi	a5,a5,40
    7dd2:	853e                	mv	a0,a5
    7dd4:	00000097          	auipc	ra,0x0
    7dd8:	c30080e7          	jalr	-976(ra) # 7a04 <list_del>

    free(to_remove->stack);
    7ddc:	fe843783          	ld	a5,-24(s0)
    7de0:	6b9c                	ld	a5,16(a5)
    7de2:	853e                	mv	a0,a5
    7de4:	00000097          	auipc	ra,0x0
    7de8:	82c080e7          	jalr	-2004(ra) # 7610 <free>
    free(to_remove);
    7dec:	fe843503          	ld	a0,-24(s0)
    7df0:	00000097          	auipc	ra,0x0
    7df4:	820080e7          	jalr	-2016(ra) # 7610 <free>

    __schedule();
    7df8:	00000097          	auipc	ra,0x0
    7dfc:	5e8080e7          	jalr	1512(ra) # 83e0 <__schedule>
    __dispatch();
    7e00:	00000097          	auipc	ra,0x0
    7e04:	416080e7          	jalr	1046(ra) # 8216 <__dispatch>
    thrdresume(main_thrd_id);
    7e08:	00003797          	auipc	a5,0x3
    7e0c:	7c078793          	addi	a5,a5,1984 # b5c8 <main_thrd_id>
    7e10:	439c                	lw	a5,0(a5)
    7e12:	853e                	mv	a0,a5
    7e14:	fffff097          	auipc	ra,0xfffff
    7e18:	30e080e7          	jalr	782(ra) # 7122 <thrdresume>
}
    7e1c:	0001                	nop
    7e1e:	60e2                	ld	ra,24(sp)
    7e20:	6442                	ld	s0,16(sp)
    7e22:	6105                	addi	sp,sp,32
    7e24:	8082                	ret

0000000000007e26 <thread_exit>:

void thread_exit(void)
{
    7e26:	7179                	addi	sp,sp,-48
    7e28:	f406                	sd	ra,40(sp)
    7e2a:	f022                	sd	s0,32(sp)
    7e2c:	1800                	addi	s0,sp,48
    if (current == &run_queue) {
    7e2e:	0000a797          	auipc	a5,0xa
    7e32:	fda78793          	addi	a5,a5,-38 # 11e08 <current>
    7e36:	6398                	ld	a4,0(a5)
    7e38:	00003797          	auipc	a5,0x3
    7e3c:	76878793          	addi	a5,a5,1896 # b5a0 <run_queue>
    7e40:	02f71063          	bne	a4,a5,7e60 <thread_exit+0x3a>
        fprintf(2, "[FATAL] thread_exit is called on a nonexistent thread\n");
    7e44:	00003597          	auipc	a1,0x3
    7e48:	4cc58593          	addi	a1,a1,1228 # b310 <schedule_edf_cbs+0x2c5a>
    7e4c:	4509                	li	a0,2
    7e4e:	fffff097          	auipc	ra,0xfffff
    7e52:	71a080e7          	jalr	1818(ra) # 7568 <fprintf>
        exit(1);
    7e56:	4505                	li	a0,1
    7e58:	fffff097          	auipc	ra,0xfffff
    7e5c:	222080e7          	jalr	546(ra) # 707a <exit>
    }

    struct thread *to_remove = list_entry(current, struct thread, thread_list);
    7e60:	0000a797          	auipc	a5,0xa
    7e64:	fa878793          	addi	a5,a5,-88 # 11e08 <current>
    7e68:	639c                	ld	a5,0(a5)
    7e6a:	fef43423          	sd	a5,-24(s0)
    7e6e:	fe843783          	ld	a5,-24(s0)
    7e72:	fd878793          	addi	a5,a5,-40
    7e76:	fef43023          	sd	a5,-32(s0)
    int consume_ticks = cancelthrdstop(to_remove->thrdstop_context_id, 1);
    7e7a:	fe043783          	ld	a5,-32(s0)
    7e7e:	5f9c                	lw	a5,56(a5)
    7e80:	4585                	li	a1,1
    7e82:	853e                	mv	a0,a5
    7e84:	fffff097          	auipc	ra,0xfffff
    7e88:	2a6080e7          	jalr	678(ra) # 712a <cancelthrdstop>
    7e8c:	87aa                	mv	a5,a0
    7e8e:	fcf42e23          	sw	a5,-36(s0)
    threading_system_time += consume_ticks;
    7e92:	0000a797          	auipc	a5,0xa
    7e96:	f7e78793          	addi	a5,a5,-130 # 11e10 <threading_system_time>
    7e9a:	439c                	lw	a5,0(a5)
    7e9c:	fdc42703          	lw	a4,-36(s0)
    7ea0:	9fb9                	addw	a5,a5,a4
    7ea2:	0007871b          	sext.w	a4,a5
    7ea6:	0000a797          	auipc	a5,0xa
    7eaa:	f6a78793          	addi	a5,a5,-150 # 11e10 <threading_system_time>
    7eae:	c398                	sw	a4,0(a5)

    __release();
    7eb0:	00000097          	auipc	ra,0x0
    7eb4:	de0080e7          	jalr	-544(ra) # 7c90 <__release>
    __thread_exit(to_remove);
    7eb8:	fe043503          	ld	a0,-32(s0)
    7ebc:	00000097          	auipc	ra,0x0
    7ec0:	ef2080e7          	jalr	-270(ra) # 7dae <__thread_exit>
}
    7ec4:	0001                	nop
    7ec6:	70a2                	ld	ra,40(sp)
    7ec8:	7402                	ld	s0,32(sp)
    7eca:	6145                	addi	sp,sp,48
    7ecc:	8082                	ret

0000000000007ece <__finish_current>:

void __finish_current()
{
    7ece:	7179                	addi	sp,sp,-48
    7ed0:	f406                	sd	ra,40(sp)
    7ed2:	f022                	sd	s0,32(sp)
    7ed4:	1800                	addi	s0,sp,48
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
    7ed6:	0000a797          	auipc	a5,0xa
    7eda:	f3278793          	addi	a5,a5,-206 # 11e08 <current>
    7ede:	639c                	ld	a5,0(a5)
    7ee0:	fef43423          	sd	a5,-24(s0)
    7ee4:	fe843783          	ld	a5,-24(s0)
    7ee8:	fd878793          	addi	a5,a5,-40
    7eec:	fef43023          	sd	a5,-32(s0)
    --current_thread->n;
    7ef0:	fe043783          	ld	a5,-32(s0)
    7ef4:	4bbc                	lw	a5,80(a5)
    7ef6:	37fd                	addiw	a5,a5,-1
    7ef8:	0007871b          	sext.w	a4,a5
    7efc:	fe043783          	ld	a5,-32(s0)
    7f00:	cbb8                	sw	a4,80(a5)

    printf("thread#%d finish at %d\n",
    7f02:	fe043783          	ld	a5,-32(s0)
    7f06:	5fd8                	lw	a4,60(a5)
    7f08:	0000a797          	auipc	a5,0xa
    7f0c:	f0878793          	addi	a5,a5,-248 # 11e10 <threading_system_time>
    7f10:	4390                	lw	a2,0(a5)
    7f12:	fe043783          	ld	a5,-32(s0)
    7f16:	4bbc                	lw	a5,80(a5)
    7f18:	86be                	mv	a3,a5
    7f1a:	85ba                	mv	a1,a4
    7f1c:	00003517          	auipc	a0,0x3
    7f20:	42c50513          	addi	a0,a0,1068 # b348 <schedule_edf_cbs+0x2c92>
    7f24:	fffff097          	auipc	ra,0xfffff
    7f28:	69c080e7          	jalr	1692(ra) # 75c0 <printf>
           current_thread->ID, threading_system_time, current_thread->n);

    if (current_thread->n > 0) {
    7f2c:	fe043783          	ld	a5,-32(s0)
    7f30:	4bbc                	lw	a5,80(a5)
    7f32:	04f05563          	blez	a5,7f7c <__finish_current+0xae>
        struct list_head *to_remove = current;
    7f36:	0000a797          	auipc	a5,0xa
    7f3a:	ed278793          	addi	a5,a5,-302 # 11e08 <current>
    7f3e:	639c                	ld	a5,0(a5)
    7f40:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
    7f44:	0000a797          	auipc	a5,0xa
    7f48:	ec478793          	addi	a5,a5,-316 # 11e08 <current>
    7f4c:	639c                	ld	a5,0(a5)
    7f4e:	6798                	ld	a4,8(a5)
    7f50:	0000a797          	auipc	a5,0xa
    7f54:	eb878793          	addi	a5,a5,-328 # 11e08 <current>
    7f58:	e398                	sd	a4,0(a5)
        list_del(to_remove);
    7f5a:	fd843503          	ld	a0,-40(s0)
    7f5e:	00000097          	auipc	ra,0x0
    7f62:	aa6080e7          	jalr	-1370(ra) # 7a04 <list_del>
        thread_add_at(current_thread, current_thread->current_deadline);
    7f66:	fe043783          	ld	a5,-32(s0)
    7f6a:	4fbc                	lw	a5,88(a5)
    7f6c:	85be                	mv	a1,a5
    7f6e:	fe043503          	ld	a0,-32(s0)
    7f72:	00000097          	auipc	ra,0x0
    7f76:	c9e080e7          	jalr	-866(ra) # 7c10 <thread_add_at>
    } else {
        __thread_exit(current_thread);
    }
}
    7f7a:	a039                	j	7f88 <__finish_current+0xba>
        __thread_exit(current_thread);
    7f7c:	fe043503          	ld	a0,-32(s0)
    7f80:	00000097          	auipc	ra,0x0
    7f84:	e2e080e7          	jalr	-466(ra) # 7dae <__thread_exit>
}
    7f88:	0001                	nop
    7f8a:	70a2                	ld	ra,40(sp)
    7f8c:	7402                	ld	s0,32(sp)
    7f8e:	6145                	addi	sp,sp,48
    7f90:	8082                	ret

0000000000007f92 <__rt_finish_current>:
void __rt_finish_current()
{
    7f92:	7179                	addi	sp,sp,-48
    7f94:	f406                	sd	ra,40(sp)
    7f96:	f022                	sd	s0,32(sp)
    7f98:	1800                	addi	s0,sp,48
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
    7f9a:	0000a797          	auipc	a5,0xa
    7f9e:	e6e78793          	addi	a5,a5,-402 # 11e08 <current>
    7fa2:	639c                	ld	a5,0(a5)
    7fa4:	fef43423          	sd	a5,-24(s0)
    7fa8:	fe843783          	ld	a5,-24(s0)
    7fac:	fd878793          	addi	a5,a5,-40
    7fb0:	fef43023          	sd	a5,-32(s0)
    --current_thread->n;
    7fb4:	fe043783          	ld	a5,-32(s0)
    7fb8:	4bbc                	lw	a5,80(a5)
    7fba:	37fd                	addiw	a5,a5,-1
    7fbc:	0007871b          	sext.w	a4,a5
    7fc0:	fe043783          	ld	a5,-32(s0)
    7fc4:	cbb8                	sw	a4,80(a5)

    printf("thread#%d finish one cycle at %d: %d cycles left\n",
    7fc6:	fe043783          	ld	a5,-32(s0)
    7fca:	5fd8                	lw	a4,60(a5)
    7fcc:	0000a797          	auipc	a5,0xa
    7fd0:	e4478793          	addi	a5,a5,-444 # 11e10 <threading_system_time>
    7fd4:	4390                	lw	a2,0(a5)
    7fd6:	fe043783          	ld	a5,-32(s0)
    7fda:	4bbc                	lw	a5,80(a5)
    7fdc:	86be                	mv	a3,a5
    7fde:	85ba                	mv	a1,a4
    7fe0:	00003517          	auipc	a0,0x3
    7fe4:	38050513          	addi	a0,a0,896 # b360 <schedule_edf_cbs+0x2caa>
    7fe8:	fffff097          	auipc	ra,0xfffff
    7fec:	5d8080e7          	jalr	1496(ra) # 75c0 <printf>
           current_thread->ID, threading_system_time, current_thread->n);

    if (current_thread->n > 0) {
    7ff0:	fe043783          	ld	a5,-32(s0)
    7ff4:	4bbc                	lw	a5,80(a5)
    7ff6:	04f05f63          	blez	a5,8054 <__rt_finish_current+0xc2>
        struct list_head *to_remove = current;
    7ffa:	0000a797          	auipc	a5,0xa
    7ffe:	e0e78793          	addi	a5,a5,-498 # 11e08 <current>
    8002:	639c                	ld	a5,0(a5)
    8004:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
    8008:	0000a797          	auipc	a5,0xa
    800c:	e0078793          	addi	a5,a5,-512 # 11e08 <current>
    8010:	639c                	ld	a5,0(a5)
    8012:	6798                	ld	a4,8(a5)
    8014:	0000a797          	auipc	a5,0xa
    8018:	df478793          	addi	a5,a5,-524 # 11e08 <current>
    801c:	e398                	sd	a4,0(a5)
        list_del(to_remove);
    801e:	fd843503          	ld	a0,-40(s0)
    8022:	00000097          	auipc	ra,0x0
    8026:	9e2080e7          	jalr	-1566(ra) # 7a04 <list_del>
        thread_add_at(current_thread, current_thread->current_deadline);
    802a:	fe043783          	ld	a5,-32(s0)
    802e:	4fbc                	lw	a5,88(a5)
    8030:	85be                	mv	a1,a5
    8032:	fe043503          	ld	a0,-32(s0)
    8036:	00000097          	auipc	ra,0x0
    803a:	bda080e7          	jalr	-1062(ra) # 7c10 <thread_add_at>
        if (!current_thread->cbs.is_hard_rt) {
    803e:	fe043783          	ld	a5,-32(s0)
    8042:	57fc                	lw	a5,108(a5)
    8044:	ef91                	bnez	a5,8060 <__rt_finish_current+0xce>
            current_thread->cbs.remaining_budget = current_thread->cbs.budget;
    8046:	fe043783          	ld	a5,-32(s0)
    804a:	53f8                	lw	a4,100(a5)
    804c:	fe043783          	ld	a5,-32(s0)
    8050:	d7b8                	sw	a4,104(a5)
        }
    } else {
        __thread_exit(current_thread);
    }
}
    8052:	a039                	j	8060 <__rt_finish_current+0xce>
        __thread_exit(current_thread);
    8054:	fe043503          	ld	a0,-32(s0)
    8058:	00000097          	auipc	ra,0x0
    805c:	d56080e7          	jalr	-682(ra) # 7dae <__thread_exit>
}
    8060:	0001                	nop
    8062:	70a2                	ld	ra,40(sp)
    8064:	7402                	ld	s0,32(sp)
    8066:	6145                	addi	sp,sp,48
    8068:	8082                	ret

000000000000806a <switch_handler>:

void switch_handler(void *arg)
{
    806a:	7139                	addi	sp,sp,-64
    806c:	fc06                	sd	ra,56(sp)
    806e:	f822                	sd	s0,48(sp)
    8070:	0080                	addi	s0,sp,64
    8072:	fca43423          	sd	a0,-56(s0)
    uint64 elapsed_time = (uint64)arg;
    8076:	fc843783          	ld	a5,-56(s0)
    807a:	fef43423          	sd	a5,-24(s0)
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
    807e:	0000a797          	auipc	a5,0xa
    8082:	d8a78793          	addi	a5,a5,-630 # 11e08 <current>
    8086:	639c                	ld	a5,0(a5)
    8088:	fef43023          	sd	a5,-32(s0)
    808c:	fe043783          	ld	a5,-32(s0)
    8090:	fd878793          	addi	a5,a5,-40
    8094:	fcf43c23          	sd	a5,-40(s0)

    threading_system_time += elapsed_time;
    8098:	fe843783          	ld	a5,-24(s0)
    809c:	0007871b          	sext.w	a4,a5
    80a0:	0000a797          	auipc	a5,0xa
    80a4:	d7078793          	addi	a5,a5,-656 # 11e10 <threading_system_time>
    80a8:	439c                	lw	a5,0(a5)
    80aa:	2781                	sext.w	a5,a5
    80ac:	9fb9                	addw	a5,a5,a4
    80ae:	2781                	sext.w	a5,a5
    80b0:	0007871b          	sext.w	a4,a5
    80b4:	0000a797          	auipc	a5,0xa
    80b8:	d5c78793          	addi	a5,a5,-676 # 11e10 <threading_system_time>
    80bc:	c398                	sw	a4,0(a5)
     __release();
    80be:	00000097          	auipc	ra,0x0
    80c2:	bd2080e7          	jalr	-1070(ra) # 7c90 <__release>
    current_thread->remaining_time -= elapsed_time;
    80c6:	fd843783          	ld	a5,-40(s0)
    80ca:	4bfc                	lw	a5,84(a5)
    80cc:	0007871b          	sext.w	a4,a5
    80d0:	fe843783          	ld	a5,-24(s0)
    80d4:	2781                	sext.w	a5,a5
    80d6:	40f707bb          	subw	a5,a4,a5
    80da:	2781                	sext.w	a5,a5
    80dc:	0007871b          	sext.w	a4,a5
    80e0:	fd843783          	ld	a5,-40(s0)
    80e4:	cbf8                	sw	a4,84(a5)
    if (!current_thread->cbs.is_hard_rt) {
    80e6:	fd843783          	ld	a5,-40(s0)
    80ea:	57fc                	lw	a5,108(a5)
    80ec:	e38d                	bnez	a5,810e <switch_handler+0xa4>
        current_thread->cbs.remaining_budget -= elapsed_time;
    80ee:	fd843783          	ld	a5,-40(s0)
    80f2:	57bc                	lw	a5,104(a5)
    80f4:	0007871b          	sext.w	a4,a5
    80f8:	fe843783          	ld	a5,-24(s0)
    80fc:	2781                	sext.w	a5,a5
    80fe:	40f707bb          	subw	a5,a4,a5
    8102:	2781                	sext.w	a5,a5
    8104:	0007871b          	sext.w	a4,a5
    8108:	fd843783          	ld	a5,-40(s0)
    810c:	d7b8                	sw	a4,104(a5)
    }
    if (current_thread->is_real_time)
    810e:	fd843783          	ld	a5,-40(s0)
    8112:	43bc                	lw	a5,64(a5)
    8114:	c3ad                	beqz	a5,8176 <switch_handler+0x10c>
        if (threading_system_time > current_thread->current_deadline || 
    8116:	fd843783          	ld	a5,-40(s0)
    811a:	4fb8                	lw	a4,88(a5)
    811c:	0000a797          	auipc	a5,0xa
    8120:	cf478793          	addi	a5,a5,-780 # 11e10 <threading_system_time>
    8124:	439c                	lw	a5,0(a5)
    8126:	02f74163          	blt	a4,a5,8148 <switch_handler+0xde>
            (threading_system_time == current_thread->current_deadline && current_thread->remaining_time > 0)) {
    812a:	fd843783          	ld	a5,-40(s0)
    812e:	4fb8                	lw	a4,88(a5)
    8130:	0000a797          	auipc	a5,0xa
    8134:	ce078793          	addi	a5,a5,-800 # 11e10 <threading_system_time>
    8138:	439c                	lw	a5,0(a5)
        if (threading_system_time > current_thread->current_deadline || 
    813a:	02f71e63          	bne	a4,a5,8176 <switch_handler+0x10c>
            (threading_system_time == current_thread->current_deadline && current_thread->remaining_time > 0)) {
    813e:	fd843783          	ld	a5,-40(s0)
    8142:	4bfc                	lw	a5,84(a5)
    8144:	02f05963          	blez	a5,8176 <switch_handler+0x10c>
            printf("thread#%d misses a deadline at %d in swicth\n", current_thread->ID, threading_system_time);
    8148:	fd843783          	ld	a5,-40(s0)
    814c:	5fd8                	lw	a4,60(a5)
    814e:	0000a797          	auipc	a5,0xa
    8152:	cc278793          	addi	a5,a5,-830 # 11e10 <threading_system_time>
    8156:	439c                	lw	a5,0(a5)
    8158:	863e                	mv	a2,a5
    815a:	85ba                	mv	a1,a4
    815c:	00003517          	auipc	a0,0x3
    8160:	23c50513          	addi	a0,a0,572 # b398 <schedule_edf_cbs+0x2ce2>
    8164:	fffff097          	auipc	ra,0xfffff
    8168:	45c080e7          	jalr	1116(ra) # 75c0 <printf>
            exit(0);
    816c:	4501                	li	a0,0
    816e:	fffff097          	auipc	ra,0xfffff
    8172:	f0c080e7          	jalr	-244(ra) # 707a <exit>
        }

    if (current_thread->remaining_time <= 0) {
    8176:	fd843783          	ld	a5,-40(s0)
    817a:	4bfc                	lw	a5,84(a5)
    817c:	02f04063          	bgtz	a5,819c <switch_handler+0x132>
        if (current_thread->is_real_time)
    8180:	fd843783          	ld	a5,-40(s0)
    8184:	43bc                	lw	a5,64(a5)
    8186:	c791                	beqz	a5,8192 <switch_handler+0x128>
            __rt_finish_current();
    8188:	00000097          	auipc	ra,0x0
    818c:	e0a080e7          	jalr	-502(ra) # 7f92 <__rt_finish_current>
    8190:	a881                	j	81e0 <switch_handler+0x176>
        else
            __finish_current();
    8192:	00000097          	auipc	ra,0x0
    8196:	d3c080e7          	jalr	-708(ra) # 7ece <__finish_current>
    819a:	a099                	j	81e0 <switch_handler+0x176>
    } else {
        // move the current thread to the end of the run_queue
        struct list_head *to_remove = current;
    819c:	0000a797          	auipc	a5,0xa
    81a0:	c6c78793          	addi	a5,a5,-916 # 11e08 <current>
    81a4:	639c                	ld	a5,0(a5)
    81a6:	fcf43823          	sd	a5,-48(s0)
        current = current->prev;
    81aa:	0000a797          	auipc	a5,0xa
    81ae:	c5e78793          	addi	a5,a5,-930 # 11e08 <current>
    81b2:	639c                	ld	a5,0(a5)
    81b4:	6798                	ld	a4,8(a5)
    81b6:	0000a797          	auipc	a5,0xa
    81ba:	c5278793          	addi	a5,a5,-942 # 11e08 <current>
    81be:	e398                	sd	a4,0(a5)
        list_del(to_remove);
    81c0:	fd043503          	ld	a0,-48(s0)
    81c4:	00000097          	auipc	ra,0x0
    81c8:	840080e7          	jalr	-1984(ra) # 7a04 <list_del>
        list_add_tail(to_remove, &run_queue);
    81cc:	00003597          	auipc	a1,0x3
    81d0:	3d458593          	addi	a1,a1,980 # b5a0 <run_queue>
    81d4:	fd043503          	ld	a0,-48(s0)
    81d8:	fffff097          	auipc	ra,0xfffff
    81dc:	7d0080e7          	jalr	2000(ra) # 79a8 <list_add_tail>
    }

    __release();
    81e0:	00000097          	auipc	ra,0x0
    81e4:	ab0080e7          	jalr	-1360(ra) # 7c90 <__release>
    __schedule();
    81e8:	00000097          	auipc	ra,0x0
    81ec:	1f8080e7          	jalr	504(ra) # 83e0 <__schedule>
    __dispatch();
    81f0:	00000097          	auipc	ra,0x0
    81f4:	026080e7          	jalr	38(ra) # 8216 <__dispatch>
    thrdresume(main_thrd_id);
    81f8:	00003797          	auipc	a5,0x3
    81fc:	3d078793          	addi	a5,a5,976 # b5c8 <main_thrd_id>
    8200:	439c                	lw	a5,0(a5)
    8202:	853e                	mv	a0,a5
    8204:	fffff097          	auipc	ra,0xfffff
    8208:	f1e080e7          	jalr	-226(ra) # 7122 <thrdresume>
}
    820c:	0001                	nop
    820e:	70e2                	ld	ra,56(sp)
    8210:	7442                	ld	s0,48(sp)
    8212:	6121                	addi	sp,sp,64
    8214:	8082                	ret

0000000000008216 <__dispatch>:

void __dispatch()
{
    8216:	7179                	addi	sp,sp,-48
    8218:	f406                	sd	ra,40(sp)
    821a:	f022                	sd	s0,32(sp)
    821c:	1800                	addi	s0,sp,48
    if (current == &run_queue) {
    821e:	0000a797          	auipc	a5,0xa
    8222:	bea78793          	addi	a5,a5,-1046 # 11e08 <current>
    8226:	6398                	ld	a4,0(a5)
    8228:	00003797          	auipc	a5,0x3
    822c:	37878793          	addi	a5,a5,888 # b5a0 <run_queue>
    8230:	1af70363          	beq	a4,a5,83d6 <__dispatch+0x1c0>
    if (allocated_time < 0) {
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
    8234:	0000a797          	auipc	a5,0xa
    8238:	bd478793          	addi	a5,a5,-1068 # 11e08 <current>
    823c:	639c                	ld	a5,0(a5)
    823e:	fef43423          	sd	a5,-24(s0)
    8242:	fe843783          	ld	a5,-24(s0)
    8246:	fd878793          	addi	a5,a5,-40
    824a:	fef43023          	sd	a5,-32(s0)
    ...
    824e:	fe043783          	ld	a5,-32(s0)
    8252:	5fcc                	lw	a1,60(a5)
    8254:	0000a797          	auipc	a5,0xa
    8258:	bbc78793          	addi	a5,a5,-1092 # 11e10 <threading_system_time>
    825c:	4390                	lw	a2,0(a5)
    825e:	0000a797          	auipc	a5,0xa
    8262:	bba78793          	addi	a5,a5,-1094 # 11e18 <allocated_time>
    8266:	6394                	ld	a3,0(a5)
    8268:	fe043783          	ld	a5,-32(s0)
    826c:	4bfc                	lw	a5,84(a5)
    826e:	873e                	mv	a4,a5
    8270:	00003517          	auipc	a0,0x3
    8274:	15850513          	addi	a0,a0,344 # b3c8 <schedule_edf_cbs+0x2d12>
    8278:	fffff097          	auipc	ra,0xfffff
    827c:	348080e7          	jalr	840(ra) # 75c0 <printf>

    if (current_thread->is_real_time && allocated_time == 0 && current_thread->cbs.is_hard_rt) {
    8280:	fe043783          	ld	a5,-32(s0)
    8284:	43bc                	lw	a5,64(a5)
    8286:	c3a1                	beqz	a5,82c6 <__dispatch+0xb0>
    8288:	0000a797          	auipc	a5,0xa
    828c:	b9078793          	addi	a5,a5,-1136 # 11e18 <allocated_time>
    8290:	639c                	ld	a5,0(a5)
    8292:	eb95                	bnez	a5,82c6 <__dispatch+0xb0>
    8294:	fe043783          	ld	a5,-32(s0)
    8298:	57fc                	lw	a5,108(a5)
    829a:	c795                	beqz	a5,82c6 <__dispatch+0xb0>
        printf("thread#%d misses a deadline at %d in dispatch\n", current_thread->ID, current_thread->current_deadline);
    829c:	fe043783          	ld	a5,-32(s0)
    82a0:	5fd8                	lw	a4,60(a5)
    82a2:	fe043783          	ld	a5,-32(s0)
    82a6:	4fbc                	lw	a5,88(a5)
    82a8:	863e                	mv	a2,a5
    82aa:	85ba                	mv	a1,a4
    82ac:	00003517          	auipc	a0,0x3
    82b0:	16c50513          	addi	a0,a0,364 # b418 <schedule_edf_cbs+0x2d62>
    82b4:	fffff097          	auipc	ra,0xfffff
    82b8:	30c080e7          	jalr	780(ra) # 75c0 <printf>
        exit(0);
    82bc:	4501                	li	a0,0
    82be:	fffff097          	auipc	ra,0xfffff
    82c2:	dbc080e7          	jalr	-580(ra) # 707a <exit>
    }

    printf("dispatch thread#%d at %d: allocated_time=%d\n", current_thread->ID, threading_system_time, allocated_time);
    82c6:	fe043783          	ld	a5,-32(s0)
    82ca:	5fd8                	lw	a4,60(a5)
    82cc:	0000a797          	auipc	a5,0xa
    82d0:	b4478793          	addi	a5,a5,-1212 # 11e10 <threading_system_time>
    82d4:	4390                	lw	a2,0(a5)
    82d6:	0000a797          	auipc	a5,0xa
    82da:	b4278793          	addi	a5,a5,-1214 # 11e18 <allocated_time>
    82de:	639c                	ld	a5,0(a5)
    82e0:	86be                	mv	a3,a5
    82e2:	85ba                	mv	a1,a4
    82e4:	00003517          	auipc	a0,0x3
    82e8:	16450513          	addi	a0,a0,356 # b448 <schedule_edf_cbs+0x2d92>
    82ec:	fffff097          	auipc	ra,0xfffff
    82f0:	2d4080e7          	jalr	724(ra) # 75c0 <printf>

    if (current_thread->buf_set) {
    82f4:	fe043783          	ld	a5,-32(s0)
    82f8:	539c                	lw	a5,32(a5)
    82fa:	c7a1                	beqz	a5,8342 <__dispatch+0x12c>
        thrdstop(allocated_time, &(current_thread->thrdstop_context_id), switch_handler, (void *)allocated_time);
    82fc:	0000a797          	auipc	a5,0xa
    8300:	b1c78793          	addi	a5,a5,-1252 # 11e18 <allocated_time>
    8304:	639c                	ld	a5,0(a5)
    8306:	0007871b          	sext.w	a4,a5
    830a:	fe043783          	ld	a5,-32(s0)
    830e:	03878593          	addi	a1,a5,56
    8312:	0000a797          	auipc	a5,0xa
    8316:	b0678793          	addi	a5,a5,-1274 # 11e18 <allocated_time>
    831a:	639c                	ld	a5,0(a5)
    831c:	86be                	mv	a3,a5
    831e:	00000617          	auipc	a2,0x0
    8322:	d4c60613          	addi	a2,a2,-692 # 806a <switch_handler>
    8326:	853a                	mv	a0,a4
    8328:	fffff097          	auipc	ra,0xfffff
    832c:	df2080e7          	jalr	-526(ra) # 711a <thrdstop>
        thrdresume(current_thread->thrdstop_context_id);
    8330:	fe043783          	ld	a5,-32(s0)
    8334:	5f9c                	lw	a5,56(a5)
    8336:	853e                	mv	a0,a5
    8338:	fffff097          	auipc	ra,0xfffff
    833c:	dea080e7          	jalr	-534(ra) # 7122 <thrdresume>
    8340:	a071                	j	83cc <__dispatch+0x1b6>
    } else {
        current_thread->buf_set = 1;
    8342:	fe043783          	ld	a5,-32(s0)
    8346:	4705                	li	a4,1
    8348:	d398                	sw	a4,32(a5)
        unsigned long new_stack_p = (unsigned long)current_thread->stack_p;
    834a:	fe043783          	ld	a5,-32(s0)
    834e:	6f9c                	ld	a5,24(a5)
    8350:	fcf43c23          	sd	a5,-40(s0)
        current_thread->thrdstop_context_id = -1;
    8354:	fe043783          	ld	a5,-32(s0)
    8358:	577d                	li	a4,-1
    835a:	df98                	sw	a4,56(a5)
        thrdstop(allocated_time, &(current_thread->thrdstop_context_id), switch_handler, (void *)allocated_time);
    835c:	0000a797          	auipc	a5,0xa
    8360:	abc78793          	addi	a5,a5,-1348 # 11e18 <allocated_time>
    8364:	639c                	ld	a5,0(a5)
    8366:	0007871b          	sext.w	a4,a5
    836a:	fe043783          	ld	a5,-32(s0)
    836e:	03878593          	addi	a1,a5,56
    8372:	0000a797          	auipc	a5,0xa
    8376:	aa678793          	addi	a5,a5,-1370 # 11e18 <allocated_time>
    837a:	639c                	ld	a5,0(a5)
    837c:	86be                	mv	a3,a5
    837e:	00000617          	auipc	a2,0x0
    8382:	cec60613          	addi	a2,a2,-788 # 806a <switch_handler>
    8386:	853a                	mv	a0,a4
    8388:	fffff097          	auipc	ra,0xfffff
    838c:	d92080e7          	jalr	-622(ra) # 711a <thrdstop>
        if (current_thread->thrdstop_context_id < 0) {
    8390:	fe043783          	ld	a5,-32(s0)
    8394:	5f9c                	lw	a5,56(a5)
    8396:	0207d063          	bgez	a5,83b6 <__dispatch+0x1a0>
            fprintf(2, "[ERROR] number of threads may exceed MAX_THRD_NUM\n");
    839a:	00003597          	auipc	a1,0x3
    839e:	0de58593          	addi	a1,a1,222 # b478 <schedule_edf_cbs+0x2dc2>
    83a2:	4509                	li	a0,2
    83a4:	fffff097          	auipc	ra,0xfffff
    83a8:	1c4080e7          	jalr	452(ra) # 7568 <fprintf>
            exit(1);
    83ac:	4505                	li	a0,1
    83ae:	fffff097          	auipc	ra,0xfffff
    83b2:	ccc080e7          	jalr	-820(ra) # 707a <exit>
        }

        // set sp to stack pointer of current thread.
        asm volatile("mv sp, %0"
    83b6:	fd843783          	ld	a5,-40(s0)
    83ba:	813e                	mv	sp,a5
                     :
                     : "r"(new_stack_p));
        current_thread->fp(current_thread->arg);
    83bc:	fe043783          	ld	a5,-32(s0)
    83c0:	6398                	ld	a4,0(a5)
    83c2:	fe043783          	ld	a5,-32(s0)
    83c6:	679c                	ld	a5,8(a5)
    83c8:	853e                	mv	a0,a5
    83ca:	9702                	jalr	a4
    }
    thread_exit();
    83cc:	00000097          	auipc	ra,0x0
    83d0:	a5a080e7          	jalr	-1446(ra) # 7e26 <thread_exit>
    83d4:	a011                	j	83d8 <__dispatch+0x1c2>
        return;
    83d6:	0001                	nop
}
    83d8:	70a2                	ld	ra,40(sp)
    83da:	7402                	ld	s0,32(sp)
    83dc:	6145                	addi	sp,sp,48
    83de:	8082                	ret

00000000000083e0 <__schedule>:

void __schedule()
{
    83e0:	711d                	addi	sp,sp,-96
    83e2:	ec86                	sd	ra,88(sp)
    83e4:	e8a2                	sd	s0,80(sp)
    83e6:	1080                	addi	s0,sp,96
    struct threads_sched_args args = {
    83e8:	0000a797          	auipc	a5,0xa
    83ec:	a2878793          	addi	a5,a5,-1496 # 11e10 <threading_system_time>
    83f0:	439c                	lw	a5,0(a5)
    83f2:	fcf42c23          	sw	a5,-40(s0)
    83f6:	4789                	li	a5,2
    83f8:	fcf42e23          	sw	a5,-36(s0)
    83fc:	00003797          	auipc	a5,0x3
    8400:	1a478793          	addi	a5,a5,420 # b5a0 <run_queue>
    8404:	fef43023          	sd	a5,-32(s0)
    8408:	00003797          	auipc	a5,0x3
    840c:	1a878793          	addi	a5,a5,424 # b5b0 <release_queue>
    8410:	fef43423          	sd	a5,-24(s0)
    ...
    8414:	fd843783          	ld	a5,-40(s0)
    8418:	faf43023          	sd	a5,-96(s0)
    841c:	fe043783          	ld	a5,-32(s0)
    8420:	faf43423          	sd	a5,-88(s0)
    8424:	fe843783          	ld	a5,-24(s0)
    8428:	faf43823          	sd	a5,-80(s0)
    842c:	fa040793          	addi	a5,s0,-96
    8430:	853e                	mv	a0,a5
    8432:	00000097          	auipc	ra,0x0
    8436:	284080e7          	jalr	644(ra) # 86b6 <schedule_edf_cbs>
    843a:	872a                	mv	a4,a0
    843c:	87ae                	mv	a5,a1
    843e:	fce43423          	sd	a4,-56(s0)
    8442:	fcf43823          	sd	a5,-48(s0)
//     r = schedule_edf_cbs(args);
// #else
...
// #endif
    ...
    8446:	fc843703          	ld	a4,-56(s0)
    844a:	0000a797          	auipc	a5,0xa
    844e:	9be78793          	addi	a5,a5,-1602 # 11e08 <current>
    8452:	e398                	sd	a4,0(a5)
    allocated_time = r.allocated_time;
    8454:	fd042783          	lw	a5,-48(s0)
    8458:	873e                	mv	a4,a5
    845a:	0000a797          	auipc	a5,0xa
    845e:	9be78793          	addi	a5,a5,-1602 # 11e18 <allocated_time>
    8462:	e398                	sd	a4,0(a5)
}
    8464:	0001                	nop
    8466:	60e6                	ld	ra,88(sp)
    8468:	6446                	ld	s0,80(sp)
    846a:	6125                	addi	sp,sp,96
    846c:	8082                	ret

000000000000846e <back_to_main_handler>:

void back_to_main_handler(void *arg)
{
    846e:	1101                	addi	sp,sp,-32
    8470:	ec06                	sd	ra,24(sp)
    8472:	e822                	sd	s0,16(sp)
    8474:	1000                	addi	s0,sp,32
    8476:	fea43423          	sd	a0,-24(s0)
    sleeping = 0;
    847a:	0000a797          	auipc	a5,0xa
    847e:	99a78793          	addi	a5,a5,-1638 # 11e14 <sleeping>
    8482:	0007a023          	sw	zero,0(a5)
    threading_system_time += (uint64)arg;
    8486:	fe843783          	ld	a5,-24(s0)
    848a:	0007871b          	sext.w	a4,a5
    848e:	0000a797          	auipc	a5,0xa
    8492:	98278793          	addi	a5,a5,-1662 # 11e10 <threading_system_time>
    8496:	439c                	lw	a5,0(a5)
    8498:	2781                	sext.w	a5,a5
    849a:	9fb9                	addw	a5,a5,a4
    849c:	2781                	sext.w	a5,a5
    849e:	0007871b          	sext.w	a4,a5
    84a2:	0000a797          	auipc	a5,0xa
    84a6:	96e78793          	addi	a5,a5,-1682 # 11e10 <threading_system_time>
    84aa:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
    84ac:	00003797          	auipc	a5,0x3
    84b0:	11c78793          	addi	a5,a5,284 # b5c8 <main_thrd_id>
    84b4:	439c                	lw	a5,0(a5)
    84b6:	853e                	mv	a0,a5
    84b8:	fffff097          	auipc	ra,0xfffff
    84bc:	c6a080e7          	jalr	-918(ra) # 7122 <thrdresume>
}
    84c0:	0001                	nop
    84c2:	60e2                	ld	ra,24(sp)
    84c4:	6442                	ld	s0,16(sp)
    84c6:	6105                	addi	sp,sp,32
    84c8:	8082                	ret

00000000000084ca <thread_start_threading>:

void thread_start_threading()
{
    84ca:	1141                	addi	sp,sp,-16
    84cc:	e406                	sd	ra,8(sp)
    84ce:	e022                	sd	s0,0(sp)
    84d0:	0800                	addi	s0,sp,16
    threading_system_time = 0;
    84d2:	0000a797          	auipc	a5,0xa
    84d6:	93e78793          	addi	a5,a5,-1730 # 11e10 <threading_system_time>
    84da:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
    84de:	0000a797          	auipc	a5,0xa
    84e2:	92a78793          	addi	a5,a5,-1750 # 11e08 <current>
    84e6:	00003717          	auipc	a4,0x3
    84ea:	0ba70713          	addi	a4,a4,186 # b5a0 <run_queue>
    84ee:	e398                	sd	a4,0(a5)

    // call thrdstop just for obtain an ID
    thrdstop(1000, &main_thrd_id, back_to_main_handler, (void *)0);
    84f0:	4681                	li	a3,0
    84f2:	00000617          	auipc	a2,0x0
    84f6:	f7c60613          	addi	a2,a2,-132 # 846e <back_to_main_handler>
    84fa:	00003597          	auipc	a1,0x3
    84fe:	0ce58593          	addi	a1,a1,206 # b5c8 <main_thrd_id>
    8502:	3e800513          	li	a0,1000
    8506:	fffff097          	auipc	ra,0xfffff
    850a:	c14080e7          	jalr	-1004(ra) # 711a <thrdstop>
    cancelthrdstop(main_thrd_id, 0);
    850e:	00003797          	auipc	a5,0x3
    8512:	0ba78793          	addi	a5,a5,186 # b5c8 <main_thrd_id>
    8516:	439c                	lw	a5,0(a5)
    8518:	4581                	li	a1,0
    851a:	853e                	mv	a0,a5
    851c:	fffff097          	auipc	ra,0xfffff
    8520:	c0e080e7          	jalr	-1010(ra) # 712a <cancelthrdstop>

    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
    8524:	a0c9                	j	85e6 <thread_start_threading+0x11c>
        __release();
    8526:	fffff097          	auipc	ra,0xfffff
    852a:	76a080e7          	jalr	1898(ra) # 7c90 <__release>
        __schedule();
    852e:	00000097          	auipc	ra,0x0
    8532:	eb2080e7          	jalr	-334(ra) # 83e0 <__schedule>
        cancelthrdstop(main_thrd_id, 0);
    8536:	00003797          	auipc	a5,0x3
    853a:	09278793          	addi	a5,a5,146 # b5c8 <main_thrd_id>
    853e:	439c                	lw	a5,0(a5)
    8540:	4581                	li	a1,0
    8542:	853e                	mv	a0,a5
    8544:	fffff097          	auipc	ra,0xfffff
    8548:	be6080e7          	jalr	-1050(ra) # 712a <cancelthrdstop>
        __dispatch();
    854c:	00000097          	auipc	ra,0x0
    8550:	cca080e7          	jalr	-822(ra) # 8216 <__dispatch>

        if (list_empty(&run_queue) && list_empty(&release_queue)) {
    8554:	00003517          	auipc	a0,0x3
    8558:	04c50513          	addi	a0,a0,76 # b5a0 <run_queue>
    855c:	fffff097          	auipc	ra,0xfffff
    8560:	4f2080e7          	jalr	1266(ra) # 7a4e <list_empty>
    8564:	87aa                	mv	a5,a0
    8566:	cb99                	beqz	a5,857c <thread_start_threading+0xb2>
    8568:	00003517          	auipc	a0,0x3
    856c:	04850513          	addi	a0,a0,72 # b5b0 <release_queue>
    8570:	fffff097          	auipc	ra,0xfffff
    8574:	4de080e7          	jalr	1246(ra) # 7a4e <list_empty>
    8578:	87aa                	mv	a5,a0
    857a:	ebd9                	bnez	a5,8610 <thread_start_threading+0x146>
            break;
        }

        // no thread in run_queue, release_queue not empty
        printf("run_queue is empty, sleep for %d ticks\n", allocated_time);
    857c:	0000a797          	auipc	a5,0xa
    8580:	89c78793          	addi	a5,a5,-1892 # 11e18 <allocated_time>
    8584:	639c                	ld	a5,0(a5)
    8586:	85be                	mv	a1,a5
    8588:	00003517          	auipc	a0,0x3
    858c:	f2850513          	addi	a0,a0,-216 # b4b0 <schedule_edf_cbs+0x2dfa>
    8590:	fffff097          	auipc	ra,0xfffff
    8594:	030080e7          	jalr	48(ra) # 75c0 <printf>
        sleeping = 1;
    8598:	0000a797          	auipc	a5,0xa
    859c:	87c78793          	addi	a5,a5,-1924 # 11e14 <sleeping>
    85a0:	4705                	li	a4,1
    85a2:	c398                	sw	a4,0(a5)
        thrdstop(allocated_time, &main_thrd_id, back_to_main_handler, (void *)allocated_time);
    85a4:	0000a797          	auipc	a5,0xa
    85a8:	87478793          	addi	a5,a5,-1932 # 11e18 <allocated_time>
    85ac:	639c                	ld	a5,0(a5)
    85ae:	0007871b          	sext.w	a4,a5
    85b2:	0000a797          	auipc	a5,0xa
    85b6:	86678793          	addi	a5,a5,-1946 # 11e18 <allocated_time>
    85ba:	639c                	ld	a5,0(a5)
    85bc:	86be                	mv	a3,a5
    85be:	00000617          	auipc	a2,0x0
    85c2:	eb060613          	addi	a2,a2,-336 # 846e <back_to_main_handler>
    85c6:	00003597          	auipc	a1,0x3
    85ca:	00258593          	addi	a1,a1,2 # b5c8 <main_thrd_id>
    85ce:	853a                	mv	a0,a4
    85d0:	fffff097          	auipc	ra,0xfffff
    85d4:	b4a080e7          	jalr	-1206(ra) # 711a <thrdstop>
        while (sleeping) {
    85d8:	0001                	nop
    85da:	0000a797          	auipc	a5,0xa
    85de:	83a78793          	addi	a5,a5,-1990 # 11e14 <sleeping>
    85e2:	439c                	lw	a5,0(a5)
    85e4:	fbfd                	bnez	a5,85da <thread_start_threading+0x110>
    while (!list_empty(&run_queue) || !list_empty(&release_queue)) {
    85e6:	00003517          	auipc	a0,0x3
    85ea:	fba50513          	addi	a0,a0,-70 # b5a0 <run_queue>
    85ee:	fffff097          	auipc	ra,0xfffff
    85f2:	460080e7          	jalr	1120(ra) # 7a4e <list_empty>
    85f6:	87aa                	mv	a5,a0
    85f8:	d79d                	beqz	a5,8526 <thread_start_threading+0x5c>
    85fa:	00003517          	auipc	a0,0x3
    85fe:	fb650513          	addi	a0,a0,-74 # b5b0 <release_queue>
    8602:	fffff097          	auipc	ra,0xfffff
    8606:	44c080e7          	jalr	1100(ra) # 7a4e <list_empty>
    860a:	87aa                	mv	a5,a0
    860c:	df89                	beqz	a5,8526 <thread_start_threading+0x5c>
            // zzz...
        }
    }
}
    860e:	a011                	j	8612 <thread_start_threading+0x148>
            break;
    8610:	0001                	nop
}
    8612:	0001                	nop
    8614:	60a2                	ld	ra,8(sp)
    8616:	6402                	ld	s0,0(sp)
    8618:	0141                	addi	sp,sp,16
    861a:	8082                	ret

000000000000861c <__check_deadline_miss>:
...
{   
    861c:	7139                	addi	sp,sp,-64
    861e:	fc22                	sd	s0,56(sp)
    8620:	0080                	addi	s0,sp,64
    8622:	fca43423          	sd	a0,-56(s0)
    8626:	87ae                	mv	a5,a1
    8628:	fcf42223          	sw	a5,-60(s0)
    
    struct thread *th = NULL;
    862c:	fe043423          	sd	zero,-24(s0)
    struct thread *thread_missing_deadline = NULL;
    8630:	fe043023          	sd	zero,-32(s0)
    list_for_each_entry(th, run_queue, thread_list) {
    8634:	fc843783          	ld	a5,-56(s0)
    8638:	639c                	ld	a5,0(a5)
    863a:	fcf43c23          	sd	a5,-40(s0)
    863e:	fd843783          	ld	a5,-40(s0)
    8642:	fd878793          	addi	a5,a5,-40
    8646:	fef43423          	sd	a5,-24(s0)
    864a:	a881                	j	869a <__check_deadline_miss+0x7e>
       // printf("    checking thread %d, its current deadline at time %d is %d\n", th->ID,current_time, th->current_deadline);
        if (th->current_deadline <= current_time) {
    864c:	fe843783          	ld	a5,-24(s0)
    8650:	4fb8                	lw	a4,88(a5)
    8652:	fc442783          	lw	a5,-60(s0)
    8656:	2781                	sext.w	a5,a5
    8658:	02e7c663          	blt	a5,a4,8684 <__check_deadline_miss+0x68>
            if (thread_missing_deadline == NULL)
    865c:	fe043783          	ld	a5,-32(s0)
    8660:	e791                	bnez	a5,866c <__check_deadline_miss+0x50>
                thread_missing_deadline = th;
    8662:	fe843783          	ld	a5,-24(s0)
    8666:	fef43023          	sd	a5,-32(s0)
    866a:	a829                	j	8684 <__check_deadline_miss+0x68>
            else if (th->ID < thread_missing_deadline->ID)
    866c:	fe843783          	ld	a5,-24(s0)
    8670:	5fd8                	lw	a4,60(a5)
    8672:	fe043783          	ld	a5,-32(s0)
    8676:	5fdc                	lw	a5,60(a5)
    8678:	00f75663          	bge	a4,a5,8684 <__check_deadline_miss+0x68>
                thread_missing_deadline = th;
    867c:	fe843783          	ld	a5,-24(s0)
    8680:	fef43023          	sd	a5,-32(s0)
    list_for_each_entry(th, run_queue, thread_list) {
    8684:	fe843783          	ld	a5,-24(s0)
    8688:	779c                	ld	a5,40(a5)
    868a:	fcf43823          	sd	a5,-48(s0)
    868e:	fd043783          	ld	a5,-48(s0)
    8692:	fd878793          	addi	a5,a5,-40
    8696:	fef43423          	sd	a5,-24(s0)
    869a:	fe843783          	ld	a5,-24(s0)
    869e:	02878793          	addi	a5,a5,40
    86a2:	fc843703          	ld	a4,-56(s0)
    86a6:	faf713e3          	bne	a4,a5,864c <__check_deadline_miss+0x30>
        }
    }
    return thread_missing_deadline;
    86aa:	fe043783          	ld	a5,-32(s0)
}
    86ae:	853e                	mv	a0,a5
...
00000000000086b6 <schedule_edf_cbs>:
{
    // TO DO
}*/
//  EDF_CBS scheduler
...
{
    86b6:	7131                	addi	sp,sp,-192
    86b8:	fd06                	sd	ra,184(sp)
    86ba:	f922                	sd	s0,176(sp)
    86bc:	f526                	sd	s1,168(sp)
    86be:	f14a                	sd	s2,160(sp)
    86c0:	ed4e                	sd	s3,152(sp)
    86c2:	0180                	addi	s0,sp,192
    86c4:	84aa                	mv	s1,a0
   
   
    struct threads_sched_result r;
    struct thread *next = NULL;
    86c6:	fa043023          	sd	zero,-96(s0)
    struct release_queue_entry *awating_rqe = NULL;
    86ca:	fa043423          	sd	zero,-88(s0)
    struct release_queue_entry *h_awating_rqe = NULL;
    86ce:	fa043823          	sd	zero,-80(s0)
    struct thread *th = NULL;
    86d2:	fa043c23          	sd	zero,-72(s0)

    
    struct thread *thread_missing_deadline = __check_deadline_miss(args.run_queue,args.current_time);
    86d6:	649c                	ld	a5,8(s1)
    86d8:	4098                	lw	a4,0(s1)
    86da:	85ba                	mv	a1,a4
    86dc:	853e                	mv	a0,a5
    86de:	00000097          	auipc	ra,0x0
    86e2:	f3e080e7          	jalr	-194(ra) # 861c <__check_deadline_miss>
    86e6:	f8a43c23          	sd	a0,-104(s0)
    if(thread_missing_deadline){
    86ea:	f9843783          	ld	a5,-104(s0)
    86ee:	c7b5                	beqz	a5,875a <schedule_edf_cbs+0xa4>
        printf("     we have found a missing thread and its thread %d \n", thread_missing_deadline->ID);
    86f0:	f9843783          	ld	a5,-104(s0)
    86f4:	5fdc                	lw	a5,60(a5)
    86f6:	85be                	mv	a1,a5
    86f8:	00003517          	auipc	a0,0x3
    86fc:	de050513          	addi	a0,a0,-544 # b4d8 <schedule_edf_cbs+0x2e22>
    8700:	fffff097          	auipc	ra,0xfffff
    8704:	ec0080e7          	jalr	-320(ra) # 75c0 <printf>
        if(thread_missing_deadline->cbs.is_hard_rt){
    8708:	f9843783          	ld	a5,-104(s0)
    870c:	57fc                	lw	a5,108(a5)
    870e:	c395                	beqz	a5,8732 <schedule_edf_cbs+0x7c>
            r.scheduled_thread_list_member = &thread_missing_deadline->thread_list;
    8710:	f9843783          	ld	a5,-104(s0)
    8714:	02878793          	addi	a5,a5,40
    8718:	f4f43023          	sd	a5,-192(s0)
            r.allocated_time = 0;     
    871c:	f4042423          	sw	zero,-184(s0)
            return r;
    8720:	f4043783          	ld	a5,-192(s0)
    8724:	f4f43823          	sd	a5,-176(s0)
    8728:	f4843783          	ld	a5,-184(s0)
    872c:	f4f43c23          	sd	a5,-168(s0)
    8730:	a13d                	j	8b5e <schedule_edf_cbs+0x4a8>
        }else{
            thread_missing_deadline->current_deadline = args.current_time + thread_missing_deadline->period;
    8732:	4098                	lw	a4,0(s1)
    8734:	f9843783          	ld	a5,-104(s0)
    8738:	47fc                	lw	a5,76(a5)
    873a:	9fb9                	addw	a5,a5,a4
    873c:	0007871b          	sext.w	a4,a5
    8740:	f9843783          	ld	a5,-104(s0)
    8744:	cfb8                	sw	a4,88(a5)
            thread_missing_deadline->cbs.remaining_budget = thread_missing_deadline->cbs.budget;
    8746:	f9843783          	ld	a5,-104(s0)
    874a:	53f8                	lw	a4,100(a5)
    874c:	f9843783          	ld	a5,-104(s0)
    8750:	d7b8                	sw	a4,104(a5)
            thread_missing_deadline->cbs.is_throttled=0;
    8752:	f9843783          	ld	a5,-104(s0)
    8756:	0607a823          	sw	zero,112(a5)
...
*/
    ...
    if(!next){
    875a:	fa043783          	ld	a5,-96(s0)
    875e:	e7dd                	bnez	a5,880c <schedule_edf_cbs+0x156>
        list_for_each_entry(th, args.run_queue, thread_list) {
    8760:	649c                	ld	a5,8(s1)
    8762:	639c                	ld	a5,0(a5)
    8764:	f8f43823          	sd	a5,-112(s0)
    8768:	f9043783          	ld	a5,-112(s0)
    876c:	fd878793          	addi	a5,a5,-40
    8770:	faf43c23          	sd	a5,-72(s0)
    8774:	a069                	j	87fe <schedule_edf_cbs+0x148>
            printf("     we're looking at thread %d and is_throt is %d\n", th->ID, th->cbs.is_throttled);
    8776:	fb843783          	ld	a5,-72(s0)
    877a:	5fd8                	lw	a4,60(a5)
    877c:	fb843783          	ld	a5,-72(s0)
    8780:	5bbc                	lw	a5,112(a5)
    8782:	863e                	mv	a2,a5
    8784:	85ba                	mv	a1,a4
    8786:	00003517          	auipc	a0,0x3
    878a:	d8a50513          	addi	a0,a0,-630 # b510 <schedule_edf_cbs+0x2e5a>
    878e:	fffff097          	auipc	ra,0xfffff
    8792:	e32080e7          	jalr	-462(ra) # 75c0 <printf>
            if (next == NULL)
    8796:	fa043783          	ld	a5,-96(s0)
    879a:	e791                	bnez	a5,87a6 <schedule_edf_cbs+0xf0>
                next = th;
    879c:	fb843783          	ld	a5,-72(s0)
    87a0:	faf43023          	sd	a5,-96(s0)
    87a4:	a091                	j	87e8 <schedule_edf_cbs+0x132>
            else if(th->current_deadline < next->current_deadline)
    87a6:	fb843783          	ld	a5,-72(s0)
    87aa:	4fb8                	lw	a4,88(a5)
    87ac:	fa043783          	ld	a5,-96(s0)
    87b0:	4fbc                	lw	a5,88(a5)
    87b2:	00f75763          	bge	a4,a5,87c0 <schedule_edf_cbs+0x10a>
                next = th;
    87b6:	fb843783          	ld	a5,-72(s0)
    87ba:	faf43023          	sd	a5,-96(s0)
    87be:	a02d                	j	87e8 <schedule_edf_cbs+0x132>
            else if (th->current_deadline == next->current_deadline && th->ID < next->ID)
    87c0:	fb843783          	ld	a5,-72(s0)
    87c4:	4fb8                	lw	a4,88(a5)
    87c6:	fa043783          	ld	a5,-96(s0)
    87ca:	4fbc                	lw	a5,88(a5)
    87cc:	00f71e63          	bne	a4,a5,87e8 <schedule_edf_cbs+0x132>
    87d0:	fb843783          	ld	a5,-72(s0)
    87d4:	5fd8                	lw	a4,60(a5)
    87d6:	fa043783          	ld	a5,-96(s0)
    87da:	5fdc                	lw	a5,60(a5)
    87dc:	00f75663          	bge	a4,a5,87e8 <schedule_edf_cbs+0x132>
                next = th;
    87e0:	fb843783          	ld	a5,-72(s0)
    87e4:	faf43023          	sd	a5,-96(s0)
        list_for_each_entry(th, args.run_queue, thread_list) {
    87e8:	fb843783          	ld	a5,-72(s0)
    87ec:	779c                	ld	a5,40(a5)
    87ee:	f8f43423          	sd	a5,-120(s0)
    87f2:	f8843783          	ld	a5,-120(s0)
    87f6:	fd878793          	addi	a5,a5,-40
    87fa:	faf43c23          	sd	a5,-72(s0)
    87fe:	fb843783          	ld	a5,-72(s0)
    8802:	02878713          	addi	a4,a5,40
    8806:	649c                	ld	a5,8(s1)
    8808:	f6f717e3          	bne	a4,a5,8776 <schedule_edf_cbs+0xc0>
        }
    }
    printf("    next thread will be no.%d\n", next->ID);
    880c:	fa043783          	ld	a5,-96(s0)
    8810:	5fdc                	lw	a5,60(a5)
    8812:	85be                	mv	a1,a5
    8814:	00003517          	auipc	a0,0x3
    8818:	d3450513          	addi	a0,a0,-716 # b548 <schedule_edf_cbs+0x2e92>
    881c:	fffff097          	auipc	ra,0xfffff
    8820:	da4080e7          	jalr	-604(ra) # 75c0 <printf>

    if(next && next->cbs.is_throttled){
    8824:	fa043783          	ld	a5,-96(s0)
    8828:	cb95                	beqz	a5,885c <schedule_edf_cbs+0x1a6>
    882a:	fa043783          	ld	a5,-96(s0)
    882e:	5bbc                	lw	a5,112(a5)
    8830:	c795                	beqz	a5,885c <schedule_edf_cbs+0x1a6>
        // return throttled thread to release queue

        next->remaining_time=0;
    8832:	fa043783          	ld	a5,-96(s0)
    8836:	0407aa23          	sw	zero,84(a5)

        //__rt_finish_current();
        r.scheduled_thread_list_member = &next->thread_list;
    883a:	fa043783          	ld	a5,-96(s0)
    883e:	02878793          	addi	a5,a5,40
    8842:	f4f43023          	sd	a5,-192(s0)
        r.allocated_time = 0;     
    8846:	f4042423          	sw	zero,-184(s0)
        return r;
    884a:	f4043783          	ld	a5,-192(s0)
    884e:	f4f43823          	sd	a5,-176(s0)
    8852:	f4843783          	ld	a5,-184(s0)
    8856:	f4f43c23          	sd	a5,-168(s0)
    885a:	a611                	j	8b5e <schedule_edf_cbs+0x4a8>
        } 
    }      
    ...
    885c:	fc043023          	sd	zero,-64(s0)
    list_for_each_entry(ath, args.release_queue, thread_list) {// find thread in release queue witheralist dealine
    8860:	689c                	ld	a5,16(s1)
    8862:	639c                	ld	a5,0(a5)
    8864:	f8f43023          	sd	a5,-128(s0)
    8868:	f8043783          	ld	a5,-128(s0)
    886c:	17e1                	addi	a5,a5,-8
    886e:	fcf43023          	sd	a5,-64(s0)
    8872:	a0b5                	j	88de <schedule_edf_cbs+0x228>
        if (awating_rqe == NULL) 
    8874:	fa843783          	ld	a5,-88(s0)
    8878:	e791                	bnez	a5,8884 <schedule_edf_cbs+0x1ce>
            awating_rqe = ath;  
    887a:	fc043783          	ld	a5,-64(s0)
    887e:	faf43423          	sd	a5,-88(s0)
    8882:	a0a1                	j	88ca <schedule_edf_cbs+0x214>
        else if(awating_rqe->release_time > ath->release_time)
    8884:	fa843783          	ld	a5,-88(s0)
    8888:	4f98                	lw	a4,24(a5)
    888a:	fc043783          	ld	a5,-64(s0)
    888e:	4f9c                	lw	a5,24(a5)
    8890:	00e7d763          	bge	a5,a4,889e <schedule_edf_cbs+0x1e8>
            awating_rqe = ath;
    8894:	fc043783          	ld	a5,-64(s0)
    8898:	faf43423          	sd	a5,-88(s0)
    889c:	a03d                	j	88ca <schedule_edf_cbs+0x214>
        else if(awating_rqe->release_time == ath->release_time &&
    889e:	fa843783          	ld	a5,-88(s0)
    88a2:	4f98                	lw	a4,24(a5)
    88a4:	fc043783          	ld	a5,-64(s0)
    88a8:	4f9c                	lw	a5,24(a5)
    88aa:	02f71063          	bne	a4,a5,88ca <schedule_edf_cbs+0x214>
                awating_rqe->thrd->current_deadline > ath->thrd->current_deadline) 
    88ae:	fa843783          	ld	a5,-88(s0)
    88b2:	639c                	ld	a5,0(a5)
    88b4:	4fb8                	lw	a4,88(a5)
    88b6:	fc043783          	ld	a5,-64(s0)
    88ba:	639c                	ld	a5,0(a5)
    88bc:	4fbc                	lw	a5,88(a5)
        else if(awating_rqe->release_time == ath->release_time &&
    88be:	00e7d663          	bge	a5,a4,88ca <schedule_edf_cbs+0x214>
            awating_rqe = ath;  
    88c2:	fc043783          	ld	a5,-64(s0)
    88c6:	faf43423          	sd	a5,-88(s0)
    list_for_each_entry(ath, args.release_queue, thread_list) {// find thread in release queue witheralist dealine
    88ca:	fc043783          	ld	a5,-64(s0)
    88ce:	679c                	ld	a5,8(a5)
    88d0:	f6f43023          	sd	a5,-160(s0)
    88d4:	f6043783          	ld	a5,-160(s0)
    88d8:	17e1                	addi	a5,a5,-8
    88da:	fcf43023          	sd	a5,-64(s0)
    88de:	fc043783          	ld	a5,-64(s0)
    88e2:	00878713          	addi	a4,a5,8
    88e6:	689c                	ld	a5,16(s1)
    88e8:	f8f716e3          	bne	a4,a5,8874 <schedule_edf_cbs+0x1be>
    }

    list_for_each_entry(ath, args.release_queue, thread_list) {// find hard thread in release queue with highest priority
    88ec:	689c                	ld	a5,16(s1)
    88ee:	639c                	ld	a5,0(a5)
    88f0:	f6f43c23          	sd	a5,-136(s0)
    88f4:	f7843783          	ld	a5,-136(s0)
    88f8:	17e1                	addi	a5,a5,-8
    88fa:	fcf43023          	sd	a5,-64(s0)
    88fe:	a069                	j	8988 <schedule_edf_cbs+0x2d2>
        if (h_awating_rqe == NULL && ath->thrd->cbs.is_hard_rt) 
    8900:	fb043783          	ld	a5,-80(s0)
    8904:	eb99                	bnez	a5,891a <schedule_edf_cbs+0x264>
    8906:	fc043783          	ld	a5,-64(s0)
    890a:	639c                	ld	a5,0(a5)
    890c:	57fc                	lw	a5,108(a5)
    890e:	c791                	beqz	a5,891a <schedule_edf_cbs+0x264>
            h_awating_rqe = ath;  
    8910:	fc043783          	ld	a5,-64(s0)
    8914:	faf43823          	sd	a5,-80(s0)
    8918:	a8b1                	j	8974 <schedule_edf_cbs+0x2be>
        else if(ath->thrd->cbs.is_hard_rt && 
    891a:	fc043783          	ld	a5,-64(s0)
    891e:	639c                	ld	a5,0(a5)
    8920:	57fc                	lw	a5,108(a5)
    8922:	cf91                	beqz	a5,893e <schedule_edf_cbs+0x288>
                h_awating_rqe->release_time > ath->release_time)
    8924:	fb043783          	ld	a5,-80(s0)
    8928:	4f98                	lw	a4,24(a5)
    892a:	fc043783          	ld	a5,-64(s0)
    892e:	4f9c                	lw	a5,24(a5)
        else if(ath->thrd->cbs.is_hard_rt && 
    8930:	00e7d763          	bge	a5,a4,893e <schedule_edf_cbs+0x288>
            h_awating_rqe = ath;
    8934:	fc043783          	ld	a5,-64(s0)
    8938:	faf43823          	sd	a5,-80(s0)
    893c:	a825                	j	8974 <schedule_edf_cbs+0x2be>
        else if(ath->thrd->cbs.is_hard_rt && 
    893e:	fc043783          	ld	a5,-64(s0)
    8942:	639c                	ld	a5,0(a5)
    8944:	57fc                	lw	a5,108(a5)
    8946:	c79d                	beqz	a5,8974 <schedule_edf_cbs+0x2be>
                h_awating_rqe->release_time == ath->release_time &&
    8948:	fb043783          	ld	a5,-80(s0)
    894c:	4f98                	lw	a4,24(a5)
    894e:	fc043783          	ld	a5,-64(s0)
    8952:	4f9c                	lw	a5,24(a5)
        else if(ath->thrd->cbs.is_hard_rt && 
    8954:	02f71063          	bne	a4,a5,8974 <schedule_edf_cbs+0x2be>
                h_awating_rqe->thrd->current_deadline > ath->thrd->current_deadline) 
    8958:	fb043783          	ld	a5,-80(s0)
    895c:	639c                	ld	a5,0(a5)
    895e:	4fb8                	lw	a4,88(a5)
    8960:	fc043783          	ld	a5,-64(s0)
    8964:	639c                	ld	a5,0(a5)
    8966:	4fbc                	lw	a5,88(a5)
                h_awating_rqe->release_time == ath->release_time &&
    8968:	00e7d663          	bge	a5,a4,8974 <schedule_edf_cbs+0x2be>
                h_awating_rqe = ath;  
    896c:	fc043783          	ld	a5,-64(s0)
    8970:	faf43823          	sd	a5,-80(s0)
    list_for_each_entry(ath, args.release_queue, thread_list) {// find hard thread in release queue with highest priority
    8974:	fc043783          	ld	a5,-64(s0)
    8978:	679c                	ld	a5,8(a5)
    897a:	f6f43423          	sd	a5,-152(s0)
    897e:	f6843783          	ld	a5,-152(s0)
    8982:	17e1                	addi	a5,a5,-8
    8984:	fcf43023          	sd	a5,-64(s0)
    8988:	fc043783          	ld	a5,-64(s0)
    898c:	00878713          	addi	a4,a5,8
    8990:	689c                	ld	a5,16(s1)
    8992:	f6f717e3          	bne	a4,a5,8900 <schedule_edf_cbs+0x24a>
    }



    if(next && next->cbs.is_hard_rt)
    8996:	fa043783          	ld	a5,-96(s0)
    899a:	cb89                	beqz	a5,89ac <schedule_edf_cbs+0x2f6>
    899c:	fa043783          	ld	a5,-96(s0)
    89a0:	57fc                	lw	a5,108(a5)
    89a2:	c789                	beqz	a5,89ac <schedule_edf_cbs+0x2f6>
        awating_rqe=h_awating_rqe;
    89a4:	fb043783          	ld	a5,-80(s0)
    89a8:	faf43423          	sd	a5,-88(s0)
   


    int time_untill_awaiting_thread = 0;
    89ac:	fc042623          	sw	zero,-52(s0)
    int preempt_thread_flag=0;
    89b0:	fc042423          	sw	zero,-56(s0)
    if(awating_rqe){
    89b4:	fa843783          	ld	a5,-88(s0)
    89b8:	c3c5                	beqz	a5,8a58 <schedule_edf_cbs+0x3a2>
        printf("    awating_rqe->thrd->ID is %d",awating_rqe->thrd->ID );
    89ba:	fa843783          	ld	a5,-88(s0)
    89be:	639c                	ld	a5,0(a5)
    89c0:	5fdc                	lw	a5,60(a5)
    89c2:	85be                	mv	a1,a5
    89c4:	00003517          	auipc	a0,0x3
    89c8:	ba450513          	addi	a0,a0,-1116 # b568 <schedule_edf_cbs+0x2eb2>
    89cc:	fffff097          	auipc	ra,0xfffff
    89d0:	bf4080e7          	jalr	-1036(ra) # 75c0 <printf>
        time_untill_awaiting_thread=awating_rqe->release_time-args.current_time; 
    89d4:	fa843783          	ld	a5,-88(s0)
    89d8:	4f98                	lw	a4,24(a5)
    89da:	409c                	lw	a5,0(s1)
    89dc:	40f707bb          	subw	a5,a4,a5
    89e0:	fcf42623          	sw	a5,-52(s0)
        if (next){
    89e4:	fa043783          	ld	a5,-96(s0)
    89e8:	cba5                	beqz	a5,8a58 <schedule_edf_cbs+0x3a2>
            if(time_untill_awaiting_thread < next->remaining_time){
    89ea:	fa043783          	ld	a5,-96(s0)
    89ee:	4bf8                	lw	a4,84(a5)
    89f0:	fcc42783          	lw	a5,-52(s0)
    89f4:	2781                	sext.w	a5,a5
    89f6:	06e7d163          	bge	a5,a4,8a58 <schedule_edf_cbs+0x3a2>
                if(!next->cbs.is_hard_rt && awating_rqe->thrd->cbs.is_hard_rt)
    89fa:	fa043783          	ld	a5,-96(s0)
    89fe:	57fc                	lw	a5,108(a5)
    8a00:	eb91                	bnez	a5,8a14 <schedule_edf_cbs+0x35e>
    8a02:	fa843783          	ld	a5,-88(s0)
    8a06:	639c                	ld	a5,0(a5)
    8a08:	57fc                	lw	a5,108(a5)
    8a0a:	c789                	beqz	a5,8a14 <schedule_edf_cbs+0x35e>
                    preempt_thread_flag=1;    
    8a0c:	4785                	li	a5,1
    8a0e:	fcf42423          	sw	a5,-56(s0)
    8a12:	a099                	j	8a58 <schedule_edf_cbs+0x3a2>
                else if(next->current_deadline > awating_rqe->thrd->current_deadline)
    8a14:	fa043783          	ld	a5,-96(s0)
    8a18:	4fb8                	lw	a4,88(a5)
    8a1a:	fa843783          	ld	a5,-88(s0)
    8a1e:	639c                	ld	a5,0(a5)
    8a20:	4fbc                	lw	a5,88(a5)
    8a22:	00e7d663          	bge	a5,a4,8a2e <schedule_edf_cbs+0x378>
                    preempt_thread_flag=1;
    8a26:	4785                	li	a5,1
    8a28:	fcf42423          	sw	a5,-56(s0)
    8a2c:	a035                	j	8a58 <schedule_edf_cbs+0x3a2>
                else if(next->current_deadline == awating_rqe->thrd->current_deadline && 
    8a2e:	fa043783          	ld	a5,-96(s0)
    8a32:	4fb8                	lw	a4,88(a5)
    8a34:	fa843783          	ld	a5,-88(s0)
    8a38:	639c                	ld	a5,0(a5)
    8a3a:	4fbc                	lw	a5,88(a5)
    8a3c:	00f71e63          	bne	a4,a5,8a58 <schedule_edf_cbs+0x3a2>
                        next->ID > awating_rqe->thrd->ID)
    8a40:	fa043783          	ld	a5,-96(s0)
    8a44:	5fd8                	lw	a4,60(a5)
    8a46:	fa843783          	ld	a5,-88(s0)
    8a4a:	639c                	ld	a5,0(a5)
    8a4c:	5fdc                	lw	a5,60(a5)
                else if(next->current_deadline == awating_rqe->thrd->current_deadline && 
    8a4e:	00e7d563          	bge	a5,a4,8a58 <schedule_edf_cbs+0x3a2>
                    preempt_thread_flag=1;
    8a52:	4785                	li	a5,1
    8a54:	fcf42423          	sw	a5,-56(s0)
    ...
    //CBS mechanism
    if(next && !next->cbs.is_hard_rt){
    8a58:	fa043783          	ld	a5,-96(s0)
    8a5c:	cbd1                	beqz	a5,8af0 <schedule_edf_cbs+0x43a>
    8a5e:	fa043783          	ld	a5,-96(s0)
    8a62:	57fc                	lw	a5,108(a5)
    8a64:	e7d1                	bnez	a5,8af0 <schedule_edf_cbs+0x43a>
        int time_until_deadline= next->current_deadline-args.current_time;
    8a66:	fa043783          	ld	a5,-96(s0)
    8a6a:	4fb8                	lw	a4,88(a5)
    8a6c:	409c                	lw	a5,0(s1)
    8a6e:	40f707bb          	subw	a5,a4,a5
    8a72:	f6f42a23          	sw	a5,-140(s0)

        if(next->period * next->cbs.remaining_budget > next->cbs.budget * time_until_deadline){
    8a76:	fa043783          	ld	a5,-96(s0)
    8a7a:	47f8                	lw	a4,76(a5)
    8a7c:	fa043783          	ld	a5,-96(s0)
    8a80:	57bc                	lw	a5,104(a5)
    8a82:	02f707bb          	mulw	a5,a4,a5
    8a86:	0007869b          	sext.w	a3,a5
    8a8a:	fa043783          	ld	a5,-96(s0)
    8a8e:	53fc                	lw	a5,100(a5)
    8a90:	f7442703          	lw	a4,-140(s0)
    8a94:	02f707bb          	mulw	a5,a4,a5
    8a98:	2781                	sext.w	a5,a5
    8a9a:	8736                	mv	a4,a3
    8a9c:	02e7d263          	bge	a5,a4,8ac0 <schedule_edf_cbs+0x40a>
            next->current_deadline = args.current_time + next->period;
    8aa0:	4098                	lw	a4,0(s1)
    8aa2:	fa043783          	ld	a5,-96(s0)
    8aa6:	47fc                	lw	a5,76(a5)
    8aa8:	9fb9                	addw	a5,a5,a4
    8aaa:	0007871b          	sext.w	a4,a5
    8aae:	fa043783          	ld	a5,-96(s0)
    8ab2:	cfb8                	sw	a4,88(a5)
            next->cbs.remaining_budget = next->cbs.budget;
    8ab4:	fa043783          	ld	a5,-96(s0)
    8ab8:	53f8                	lw	a4,100(a5)
    8aba:	fa043783          	ld	a5,-96(s0)
    8abe:	d7b8                	sw	a4,104(a5)
        }

        if(next->remaining_time > next->cbs.remaining_budget){
    8ac0:	fa043783          	ld	a5,-96(s0)
    8ac4:	4bf8                	lw	a4,84(a5)
    8ac6:	fa043783          	ld	a5,-96(s0)
    8aca:	57bc                	lw	a5,104(a5)
    8acc:	02e7d263          	bge	a5,a4,8af0 <schedule_edf_cbs+0x43a>
            next->cbs.is_throttled=1;
    8ad0:	fa043783          	ld	a5,-96(s0)
    8ad4:	4705                	li	a4,1
    8ad6:	dbb8                	sw	a4,112(a5)
            next->cbs.throttle_new_deadline=next->current_deadline;
    8ad8:	fa043783          	ld	a5,-96(s0)
    8adc:	4fb8                	lw	a4,88(a5)
    8ade:	fa043783          	ld	a5,-96(s0)
    8ae2:	dfb8                	sw	a4,120(a5)
            next->cbs.remaining_time_at_throttle = next->remaining_time;
    8ae4:	fa043783          	ld	a5,-96(s0)
    8ae8:	4bf8                	lw	a4,84(a5)
    8aea:	fa043783          	ld	a5,-96(s0)
    8aee:	dff8                	sw	a4,124(a5)
        }
      
    }

    if (next != NULL) {
    8af0:	fa043783          	ld	a5,-96(s0)
    8af4:	c3a9                	beqz	a5,8b36 <schedule_edf_cbs+0x480>
        r.scheduled_thread_list_member = &next->thread_list;
    8af6:	fa043783          	ld	a5,-96(s0)
    8afa:	02878793          	addi	a5,a5,40
    8afe:	f4f43023          	sd	a5,-192(s0)
        if(awating_rqe && preempt_thread_flag)
    8b02:	fa843783          	ld	a5,-88(s0)
    8b06:	cb91                	beqz	a5,8b1a <schedule_edf_cbs+0x464>
    8b08:	fc842783          	lw	a5,-56(s0)
    8b0c:	2781                	sext.w	a5,a5
    8b0e:	c791                	beqz	a5,8b1a <schedule_edf_cbs+0x464>
            r.allocated_time = time_untill_awaiting_thread;
    8b10:	fcc42783          	lw	a5,-52(s0)
    8b14:	f4f42423          	sw	a5,-184(s0)
    8b18:	a81d                	j	8b4e <schedule_edf_cbs+0x498>
        else{
    ...
    8b1a:	fa043783          	ld	a5,-96(s0)
    8b1e:	5bbc                	lw	a5,112(a5)
    8b20:	c789                	beqz	a5,8b2a <schedule_edf_cbs+0x474>
    8b22:	fa043783          	ld	a5,-96(s0)
    8b26:	57bc                	lw	a5,104(a5)
    8b28:	a021                	j	8b30 <schedule_edf_cbs+0x47a>
    8b2a:	fa043783          	ld	a5,-96(s0)
    8b2e:	4bfc                	lw	a5,84(a5)
    8b30:	f4f42423          	sw	a5,-184(s0)
    8b34:	a829                	j	8b4e <schedule_edf_cbs+0x498>
            }

    } else {
        r.scheduled_thread_list_member = args.run_queue;
    8b36:	649c                	ld	a5,8(s1)
    8b38:	f4f43023          	sd	a5,-192(s0)
        r.allocated_time = (awating_rqe != NULL) ? time_untill_awaiting_thread : 1 ;
    8b3c:	fa843783          	ld	a5,-88(s0)
    8b40:	c781                	beqz	a5,8b48 <schedule_edf_cbs+0x492>
    8b42:	fcc42783          	lw	a5,-52(s0)
    8b46:	a011                	j	8b4a <schedule_edf_cbs+0x494>
    8b48:	4785                	li	a5,1
    8b4a:	f4f42423          	sw	a5,-184(s0)
   ...
   // __check_deadline_miss(args.run_queue,args.current_time+8);
    return r;
    8b4e:	f4043783          	ld	a5,-192(s0)
    8b52:	f4f43823          	sd	a5,-176(s0)
    8b56:	f4843783          	ld	a5,-184(s0)
    8b5a:	f4f43c23          	sd	a5,-168(s0)
    8b5e:	4701                	li	a4,0
    8b60:	f5043703          	ld	a4,-176(s0)
    8b64:	4781                	li	a5,0
    8b66:	f5843783          	ld	a5,-168(s0)
    8b6a:	893a                	mv	s2,a4
    8b6c:	89be                	mv	s3,a5
    8b6e:	874a                	mv	a4,s2
    8b70:	87ce                	mv	a5,s3
    ...
    8b72:	853a                	mv	a0,a4
    8b74:	85be                	mv	a1,a5
    8b76:	70ea                	ld	ra,184(sp)
    8b78:	744a                	ld	s0,176(sp)
    8b7a:	74aa                	ld	s1,168(sp)
    8b7c:	790a                	ld	s2,160(sp)
    8b7e:	69ea                	ld	s3,152(sp)
    8b80:	6129                	addi	sp,sp,192
    8b82:	8082                	ret
